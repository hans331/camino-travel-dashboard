...
export const SCHEDULE: DayData[] = [
  ...
  },
  {
    ...
    food: 'Eurostar 스낵 · 파리 도착 후 늦은 저녁', stay: '✅ Hôtel Sanso by HappyCulture (7/1 1박 arrival) · ₩479,202 · Grande Bibliothèque 지역',
    ...
    timeline: [
      ...
      { time: '22:45', emoji: '🚖', label: 'Gare du Nord → Hôtel Sanso (7/1 arrival 호텔, Uber ~€15-20, 15-20분)', status: 'confirmed', detail: 'Sanso by HappyCulture · Grande Bibliothèque 지역 (13구) · 다음날 오전 Hampton by Hilton으로 이동' },
      { time: '23:15', emoji: '🏨', label: 'Hôtel Sanso by HappyCulture 체크인', status: 'confirmed', detail: '✅ 7/1 arrival 1박 · ₩479,202 · Grande Bibliothèque 지역' },
    ],
  },
  ...
  },
  {
    ...
    icon: '👑', desc: '✅ 완료 — Billet Passeport (€35×3=€105) · 10:30 Entrance A · 궁전 → 트리아농 → 정원. ⚠️ 분수쇼 당일 미운영으로 못 봄. 저녁 파리 복귀 → 마레지구 비스트로.',
    ...
    timeline: [
      ...
      { time: '22:00', emoji: '🏨', label: 'Hampton By Hilton Saint Ouen 복귀', status: 'pending', detail: 'Métro 또는 Uber (야간 €15-20)' },
    ],
  },
  {
    day: 23, date: '7/4 (토)', phase: 'paris', title: '🖼️ 루브르 ✅ 11:30 입장 + 🎧 한국어 오디오 가이드 + 마레 + 노트르담',
    icon: '🖼️', desc: '✅ 루브르 11:30 입장 예매완료 (Entrée Plein tarif hors EEE €32×3=€96, Chullyoung Choi 명의) · ⭐ 한국어 오디오 가이드로 자유 관람. 모나리자·비너스·니케 핵심 작품. 점심 후 마레지구 산책 + 보주 광장 + 피카소 미술관. 늦은 오후 노트르담 + 생트샤펠 + 라탱지구.',
    ...
    timeline: [
      ...
      { time: '10:35-10:55', emoji: '🚇', label: 'Saint-Ouen (Métro 14) → Pyramides 직행 (~15분)', status: 'pending', detail: '⭐ Métro 14 자동 열차 · Pyramides 역이 루브르 도보 5분 · Navigo 또는 €1.85×3' },
      ...
      { time: '11:30', emoji: '🖼️', label: '🖼️ ⭐ 루브르 박물관 입장 ✅ 예매완료', status: 'confirmed', detail: '✅ 11:30 시간 슬롯 예매완료 · Entrée Plein tarif hors EEE (Non-EEA 성인) €32/인 × 3 = €96 · Chullyoung Choi 명의' },
      { time: '11:30-11:45', emoji: '🎧', label: '🎧 ⭐ 한국어 오디오 가이드 대여 (Nintendo 3DS)', status: 'pending', detail: '입장 후 안내 데스크 · €5/인 × 3 = €15 · 신분증 보증 · ⚠️ 도슨트 X = 개인 티켓 사용 OK' },
      ...
      { time: '16:15-17:00', emoji: '⛪', label: '⛪ 생트샤펠 (13세기 스테인드글라스, 도보 15분)', status: 'pending', detail: '€13/인 · 짧은 관람 45분 · 마레→시테섬 도보' },
  ...
  {
    day: 25, date: '7/6 (월)', phase: 'paris', title: '🏰 메르시파리 패키지 ✅ — 몽생미셀 + 지베르니 + 옹플뢰르 (한국어 가이드 16h, 🚐 호텔 픽업 €40)',
    icon: '🏰', desc: '⭐ ✅ 예매완료 (메르시파리 한국어 가이드 투어, 3명, 16시간) · 🚐 ⭐ 호텔 픽업 확정 (Hampton by Hilton Saint Ouen = 2존 €40 추가) → 지베르니 모네 정원 → 옹플뢰르 항구 (또는 고흐마을) → 몽생미셀 일몰 → 새벽 1-2시 호텔 샌딩. ⚠️ 입장료 별도 (MSM €16 + 지베르니 €13). 다음날 7/7은 회복일.',
    food: '점심 자유 (€20-30/인) · 몽생미셀 La Mère Poulard 또는 마을 비스트로 저녁 · 차내 간식', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
    ...
    timeline: [
      ...
      { time: '06:00-06:30', emoji: '🍳', label: '간단 아침 + 데이팩 최종 체크', status: 'pending', detail: '카메라·우산·자켓·간식·물·SPF·선글라스·현금 (입장료 €87 + 픽업비 €40 + 점심)' },
      { time: '06:30-06:45', emoji: '🏨', label: '🏨 호텔 로비 대기 (메르시파리 픽업)', status: 'pending', detail: '⚠️ 정확 픽업 시간 메르시파리 카톡 사전 확인 · 가이드와 직접 통화 가능 폰 준비' },
      { time: '06:50-07:10', emoji: '🚐', label: '🚐 ⭐ 메르시파리 호텔 픽업 (Hampton by Hilton Saint Ouen → 차량 탑승)', status: 'pending', detail: '⭐ 🚐 호텔 픽업 €40 추가비 (Saint-Ouen 2존, 현장 결제 또는 사전 송금) · Hampton By Hilton Paris Saint Ouen 정문' },
      ...
      { time: '01:00-02:00+1', emoji: '🏨', label: '🏨 ⚠️ 새벽 1-2시 호텔 도착 (메르시파리 샌딩)', status: 'pending', detail: '⭐ Hampton by Hilton Saint Ouen 호텔까지 직행 (픽업비 €40에 왕복 포함) · 차량에서 내려 호텔로' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '13:50-14:40', emoji: '⛪', label: '⛪ ⭐ 사크레쾨르 대성당 (무료) + 파리 전경', status: 'pending', detail: 'Anvers 쪽에서 푸니쿨라 (Navigo/t+ 티켓) 또는 계단 · 성당 앞 계단 = 파리 파노라마 · 돔 €8 옵션' },
      ...
      { time: '17:00-17:45', emoji: '💠', label: '💠 생트샤펠 (13세기 스테인드글라스) — 옵션', status: 'pending', detail: '€13/인 × 3 · 노트르담 도보 5분 · 여름 19:00까지 · 컨디션 따라 스킵하고 강변 산책 대체' },
      ...
      { time: '20:30-21:00', emoji: '🚇', label: '호텔 복귀', status: 'pending', detail: 'Odéon (M4) → Châtelet → M14 Saint-Ouen · 또는 Uber €20-25' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '09:00-10:00', emoji: '🚇', label: 'Saint-Ouen (Métro 14) → Châtelet-Les Halles → RER B → CDG (~55분)', status: 'pending', detail: 'Métro 14: 5정거장 · RER B: 30분 · 트렁크 다수 → Uber 대안 €50-70' },
...
export const TRANSPORTS: Transport[] = [
  ...
  { route: '둘째: 런던 → LGW 개트윅 (7/1)', method: '🚂 Thameslink 직행 (St Pancras→Gatwick)', time: '~45min', price: '£35-55', tip: '⚠️ JD484 21:10 — 18시까지 LGW 도착 목표 (3h 여유). Thameslink Gatwick 직행이 편리.' },
    ...
    items: [
      ...
      },
      {
        ...
        booking: {
          ...
          platform: 'Booking.com',
          accessNote: '⚠️ Eddington 북서 신개발지구 (시내 5.6km) · 시내까지 자전거 15분 / 우버 ~£10-15. 호텔 무료 자전거 활용 가능. 18세 이상만 투숙 가능.',
        },
      },
      {
        label: '🇫🇷 파리 Hôtel Sanso by HappyCulture (7/1 arrival 1박)',
        day: 'Day 20', date: '7/1 (수)', target: '👨‍👩‍👦 가족', count: '3명', price: '₩479,202 / 1박', status: 'completed',
      ...
      },
      {
        ...
        day: 'Day 21-26', date: '7/2-7/8', target: '👨‍👩‍👦 가족', count: '3명', price: '₩2,949,756 / 6박 (환불 정책 확인 필요)', status: 'completed',
        note: '✅ 예매완료 · Saint-Ouen-sur-Seine (파리 北 인접, 93구) · Hilton 체인 · Marché aux Puces 벼룩시장 인근 · 몽마르뜨·사크레쾨르 20분 · ⚠️ 원래 Clichy 아파트에서 변경 (2026-07-02) · 아들친구용 추가 방 2박 (7/2-7/4) ₩658,573 별도',
        booking: {
          platform: 'Booking.com',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        day: 'Day 23', date: '7/4 (토)', target: '👨‍👩‍👦 가족', count: '3인', price: '€32/인 × 3 = €96 (Non-EEA) + 오디오 €15 (~₩195K)', status: 'completed',
        note: '✅ 예매완료 · 11:30 시간 슬롯 · Chullyoung Choi 명의 · Entrée Plein tarif hors EEE (Non-EEA 성인 €32) · 🎧 한국어 오디오 가이드 대여 (€5/인) · ⚠️ 도슨트 X = 개인 티켓 사용 가능 · 동선: 모나리자(Denon) → 비너스·니케 → 다비드 → 이집트관 · ⭐ Carrousel 지하 입구 (Rue de Rivoli 99) 줄 짧음 · 15-20분 전 도착',
      ...
      },
      {
        ...
        note: '✅ 예매완료 · ⭐ Hampton by Hilton Saint Ouen 호텔 픽업 확정 (€40 추가, 2존) · 한국어 가이드 + 차량 · ⚠️ 입장료 (MSM €16 + 지베르니 €13) 별도 · ⚠️ 새벽 1-2시 호텔 샌딩',
      ...
      { label: '⛪ 노트르담 내부 슬롯 (무료) + 사크레쾨르·생트샤펠', day: 'Day 26', date: '7/7 (화)', target: '👨‍👩‍👦 가족', count: '3인', note: '노트르담: notredamedeparis.fr/앱 슬롯 예약 (무료) · 사크레쾨르 무료 · 생트샤펠 €13/인 현장', status: 'pending', link: { url: 'https://www.notredamedeparis.fr/', label: '노트르담 공식' } },
    ],
  },
  {
    title: '🥾 카미노 준비물 (부부 2명)',
