...
export const SCHEDULE: DayData[] = [
  ...
  // ===== PARIS (Day 21-28) — 8일 (7박), Mont-Saint-Michel 포함 =====
  {
    ...
    timeline: [
      ...
      { time: '10:00-12:00', emoji: '🚶', label: '시내 가벼운 산책 — Île de la Jatte 인상파 트레일 (호텔 도보 25분)', status: 'pending', detail: '⭐ 조르주 쇠라 "그랑드 자트섬의 일요일 오후" 배경지 · 가볍게' },
      { time: '12:00-13:00', emoji: '🚇', label: 'Clichy → Solférino (오르세역) Métro 13 → 12 환승', status: 'pending', detail: '~30-40분 · 점심 도중 식사 가능' },
  ...
  },
  {
    ...
    icon: '🏰', desc: '⭐ ✅ 예매완료 (메르시파리 한국어 가이드 투어, 3명, 16시간) · 🚐 ⭐ 호텔 픽업 확정 (Clichy 92110 = 2존 €40 추가) → 지베르니 모네 정원 → 옹플뢰르 항구 (또는 고흐마을) → 몽생미셀 일몰 → 새벽 1-2시 호텔 샌딩. ⚠️ 입장료 별도 (MSM €16 + 지베르니 €13). 다음날 7/7은 회복일.',
    ...
    timeline: [
      ...
      { time: '01:00-02:00+1', emoji: '🏨', label: '🏨 ⚠️ 새벽 1-2시 호텔 도착 (메르시파리 샌딩)', status: 'pending', detail: '⭐ Clichy 호텔까지 직행 (픽업비 €40에 왕복 포함) · 차량에서 내려 호텔로' },
...
export const ACCOMMODATIONS: Accommodation[] = [
  ...
  { phase: 'paris', city: '파리', name: 'Hampton By Hilton Paris Saint Ouen (main stay)', type: '호텔 (Booking.com)', price: '₩2,949,756 / 6박 (7/2-7/8, 3명)', desc: '✅ 예매완료 · Saint-Ouen-sur-Seine (파리 北 인접, 93구) · Métro 14 + RER C · Saint-Ouen 역 도보 1분 · Hilton 체인 · 조식 별도 옵션 · 몽마르뜨·사크레쾨르 20분 거리 · Marché aux Puces 벼룩시장 인근. ⚠️ 원래 Clichy 아파트에서 변경 · 아들친구용 추가 방 2박 (7/2-7/4) ₩658,573 별도.', emoji: '🏨',
...
export const BUDGET: BudgetItem[] = [
  ...
  },
  {
    ...
    breakdown: [
      ...
      { label: '🇫🇷 파리 Hampton By Hilton Saint Ouen (7/2-7/8, 6박, 3명)', amt: 2949756, status: 'confirmed', note: '✅ 예매완료 · Saint-Ouen (파리 北 인접, Métro 14/RER C) · ⚠️ 원래 Clichy 아파트에서 변경' },
  ...
  },
  {
    ...
    breakdown: [
      ...
      { label: '🚐 메르시파리 Clichy 호텔 픽업 추가비 (2존)', amt: 64000, status: 'pending', note: '⚠️ €40 (Clichy 92110 = 2존, 메르시파리 카톡 확정) · 호텔 직접 픽업 + 새벽 샌딩 포함 · Uber 트로카데로 이동 불필요' },
