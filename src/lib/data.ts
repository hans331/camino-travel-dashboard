...
export const SCHEDULE: DayData[] = [
  ...
  // ===== PARIS (Day 21-28) — 8일 (7박), Mont-Saint-Michel 포함 =====
  {
    ...
    timeline: [
      ...
      { time: '13:30', emoji: '🎨', label: '🎨 ⭐ 오르세 미술관 도슨트 ✅ 예매완료 (한국어)', status: 'confirmed', detail: '✅ 예매완료 · 한국어 도슨트 가이드 · 인상파 핵심 (모네·고흐·세잔·드가·르누아르) 5층 우선' },
      { time: '13:30-16:30', emoji: '🖼️', label: '⭐ 도슨트 인솔 인상파 핵심 동선 (약 3h)', status: 'pending', detail: '5층 인상파 → 0층 조각 → 2층 르동·휘슬러 · 한국어 해설로 작품 깊이 ↑' },
