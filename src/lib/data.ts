...
export const SCHEDULE: DayData[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '19:00-19:45', emoji: '🚇', label: '호텔로 이동 — Métro 14 직결', status: 'pending', detail: 'Châtelet 또는 Pyramides → Métro 14 → Saint-Ouen' },
      { time: '19:45-20:00', emoji: '🏨', label: '🏨 Hampton By Hilton Saint Ouen 복귀 (20시 전) ⭐', status: 'pending', detail: '⭐ 목표 달성 · 저녁 여유 있게 휴식' },
      { time: '20:00-22:00', emoji: '😴', label: '호텔 휴식 + 내일 7/5 일정 미리 정리', status: 'pending' },
    ],
  },
  {
    day: 24, date: '7/5 (일)', phase: 'paris', title: '🎨 l\'Orangerie + 🌳 Tuileries + 🛥️ 세느강 + 🗼 에펠탑 (7/6 메르시파리 대비)',
    icon: '🗼', desc: '⭐ 오전 l\'Orangerie 모네 수련 → Tuileries 정원 산책 → 점심 → 오후 세느강 유람선 → 트로카데로·Champ de Mars 에펠탑 외부 관람 (7/2 못 본 에펠탑 만회) → 에펠탑 근처 이른 저녁 → 21시 호텔. ⚠️ 7/6 메르시파리 05:30 기상 대비 22시 취침.',
    food: '점심 마레·생제르맹 · 이른 저녁 에펠탑 근처 (Rue Cler)', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
    lat: 48.8584, lng: 2.2945,
    transit: '🚇 Métro 14 (Saint-Ouen 직결) · 🛥️ 세느강 유람선 · 🚶 도보',
    restaurants: ['Café Constant (에펠탑 Rue Cler)', 'Le Petit Cler (Rue Cler 비스트로)', 'Breizh Café (마레 갈레트)'],
    timeline: [
      { time: '09:00-10:00', emoji: '🍳', label: '늦은 아침 + 호텔 휴식', status: 'pending', detail: '느긋한 시작 · 컨디션 보존 (내일 05:30 기상)' },
      { time: '10:00-10:20', emoji: '🚇', label: 'Saint-Ouen (Métro 14) → Madeleine → 도보 Concorde', status: 'pending', detail: '~15분 · Métro 14 직결' },
      { time: '10:30-12:00', emoji: '🎨', label: '🎨 ⭐ l\'Orangerie — 모네 수련 대벽화 (Nymphéas)', status: 'pending', detail: '€12.50/인 × 3 = €37.50 · 8개 거대 캔버스 타원형 방 · musee-orangerie.fr 사전 예매 권장 · 일요일 OK' },
      { time: '12:00-13:00', emoji: '🌳', label: '🌳 Tuileries 정원 산책 (l\'Orangerie 옆)', status: 'pending', detail: '나폴레옹 시대 프랑스식 정원 · 조각 + 분수 · 벤치 휴식' },
      { time: '13:00-14:30', emoji: '🍽️', label: '🍽️ 점심 — 생제르맹 또는 마레', status: 'pending', detail: 'Café de Flore (생제르맹 사르트르 단골) · Breizh Café 갈레트 · L\'As du Fallafel' },
      { time: '14:30-15:00', emoji: '🚶', label: 'Pont d\'Alma 선착장 이동 (Métro 또는 도보)', status: 'pending', detail: 'Bateaux-Mouches 선착장 · Alma-Marceau 역 (Métro 9)' },
      { time: '15:00-16:00', emoji: '🛥️', label: '⭐ 세느강 유람선 (Bateaux-Mouches 또는 Bateaux Parisiens)', status: 'pending', detail: '⚠️ 예매 미완료 · €17/인 × 3 = €51 · 1시간 유람 · 노트르담·에펠탑 강변 뷰 · 현장 티켓 OK (성수기 5-10분 대기)' },
      { time: '16:00-17:00', emoji: '📸', label: '⭐⭐ Trocadéro 광장 — 에펠탑 정면 사진 명소', status: 'pending', detail: '⭐ 파리 NO.1 에펠탑 사진 · Palais de Chaillot 분수 + 정원 · 낮 사진 명소 · 가족 사진 충분히' },
      { time: '17:00-17:45', emoji: '🚶', label: 'Pont d\'Iéna 다리 → Champ de Mars 잔디밭', status: 'pending', detail: '에펠탑 아래 거리감 체험 · 다리 위 사진 · 잔디밭 산책' },
      { time: '17:45-19:15', emoji: '🍽️', label: '🍽️ 에펠탑 근처 이른 저녁 (Rue Cler 시장 거리)', status: 'pending', detail: '⭐ Café Constant · Le Petit Cler · Le Sancerre · Rue Cler = 소규모 시장 + 비스트로 거리 (에펠탑 도보 5분) · 예약 권장' },
      { time: '19:15-19:45', emoji: '🌆', label: '🌆 Champ de Mars 잔디밭 — 에펠탑 저녁 마무리', status: 'pending', detail: '일몰 21:55이나 저녁 시간대 분위기 · 짧게 앉아서 인증샷 · 야경 조명은 안 기다림 (내일 대비)' },
      { time: '19:45-20:30', emoji: '🚇', label: '호텔로 이동 — Uber 권장 (빠름·편함)', status: 'pending', detail: '⭐ Uber €25-30 직행 (~30분) · 또는 Métro 6 Bir-Hakeim → 환승 다수 (~50분)' },
      { time: '20:30-21:00', emoji: '🏨', label: '🏨 호텔 도착 + 7/6 데이팩 최종 점검', status: 'pending', detail: '⭐ 카메라·우산·자켓·간식·물·SPF·선글라스·현금 (입장료 €87 + 픽업비 €40 + 점심)' },
      { time: '21:00-21:30', emoji: '📱', label: '📱 메르시파리 카톡 — 06:30 픽업 시간 재확인', status: 'pending' },
      { time: '22:00', emoji: '🛌', label: '⭐ 취침', status: 'pending', detail: '⚠️ 내일 05:30 기상 → 06:30 호텔 로비 대기 (메르시파리 픽업)' },
    ],
  },
  {
...
export const BUDGET: BudgetItem[] = [
  ...
  },
  {
    ...
    breakdown: [
      ...
      { label: '🎨 l\'Orangerie × 3 (모네 수련)', amt: 67000, status: 'pending', note: '€12.50/인 × 3 = €37.50 (~₩67K) · 7/5 (일) 10:30 슬롯 권장 · musee-orangerie.fr' },
      { label: '🛥️ 세느강 유람선 × 3 (7/5 오후)', amt: 90000, status: 'pending', note: '€17/인 × 3 = €51 (~₩90K) · Bateaux-Mouches 또는 Bateaux Parisiens · 현장 티켓 OK · 1시간 유람 · Pont d\'Alma 선착장' },
    ],
  },
  {
