...
export const SCHEDULE: DayData[] = [
  ...
  },
  {
    ...
    food: '졸업 축하 점심 · Eurostar 스낵 · 파리 비스트로 저녁', stay: '✅ Hôtel Sanso by HappyCulture (7/1 1박 arrival) · ₩479,202 · Grande Bibliothèque 지역',
    ...
    timeline: [
      ...
      { time: '22:45', emoji: '🚖', label: 'Gare du Nord → Hôtel Sanso (7/1 arrival 호텔, Uber ~€15-20, 15-20분)', status: 'pending', detail: 'Sanso by HappyCulture · Grande Bibliothèque 지역 (13구) · 다음날 오전 Hampton by Hilton으로 이동' },
      { time: '23:15', emoji: '🏨', label: 'Hôtel Sanso by HappyCulture 체크인', status: 'pending', detail: '✅ 7/1 arrival 1박 · ₩479,202 · Grande Bibliothèque 지역' },
    ],
  },
  ...
  // ===== PARIS (Day 21-28) — 8일 (7박), Mont-Saint-Michel 포함 =====
  {
    ...
    timeline: [
      ...
      { time: '12:00-13:00', emoji: '🚇', label: 'Saint-Ouen → Solférino (오르세역) RER C 또는 Métro 14 + Métro 12', status: 'pending', detail: '~30-40분 · 점심 도중 식사 가능' },
  ...
  {
    day: 23, date: '7/4 (토)', phase: 'paris', title: '🖼️ 루브르 ✅ 10:10 입장 + 🎧 한국어 오디오 가이드 + 마레 + 노트르담',
    icon: '🖼️', desc: '✅ 루브르 10:10 입장 예매완료 · ⭐ 한국어 오디오 가이드로 자유 관람 (도슨트 X — 한국어 오디오 가이드가 더 자유로움). 모나리자·비너스·니케 핵심 작품. 점심 후 마레지구 산책 + 보주 광장 + 피카소 미술관. 늦은 오후 노트르담 + 생트샤펠 + 라탱지구.',
    ...
    timeline: [
      { time: '08:00-08:45', emoji: '🍳', label: 'Hampton By Hilton Saint Ouen 아침', status: 'pending' },
      { time: '08:45-09:30', emoji: '🚇', label: 'Saint-Ouen (Métro 14) → Châtelet → Métro 1 → Palais Royal-Musée du Louvre', status: 'pending', detail: '~30분 · Navigo 또는 €1.85×3' },
      ...
      { time: '10:10-10:25', emoji: '🎧', label: '🎧 ⭐ 한국어 오디오 가이드 대여 (Nintendo 3DS)', status: 'pending', detail: '입장 후 안내 데스크 · €5/인 × 3 = €15 · 신분증 보증 · ⚠️ 도슨트 X = 개인 티켓 사용 OK' },
      { time: '10:25-11:00', emoji: '🎨', label: '⭐ 모나리자 (Denon 동, 1층) — 가장 먼저!', status: 'pending', detail: '인파 폭증 전 = 사진 명소 · 한국어 오디오 가이드 작품번호 입력' },
      { time: '11:00-12:30', emoji: '🏛️', label: '비너스·니케·라파엘로·다비드·이집트관', status: 'pending', detail: 'Denon 동 → Sully 동 동선 · 오디오 가이드 작품번호로 핵심만 집중' },
      ...
      { time: '22:00', emoji: '🏨', label: 'Hampton By Hilton Saint Ouen 복귀', status: 'pending' },
    ],
  },
  {
    ...
    food: '마레지구 점심 · 일찍 저녁', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
    ...
    timeline: [
      ...
      { time: '10:30-11:00', emoji: '🚇', label: 'Saint-Ouen → Concorde (Métro 14 → 1)', status: 'pending', detail: 'Saint-Ouen 도보 1분 → Métro 14 직결' },
      ...
      { time: '21:00', emoji: '📱', label: '📱 메르시파리 카톡 — 픽업 시간 확정 (호텔 도착 ETA)', status: 'pending', detail: '⭐ 호텔 픽업 €40 추가 결제 방식 확인 (현장? 송금?)' },
      { time: '22:00', emoji: '🛌', label: '⭐ 일찍 취침', status: 'pending', detail: '⚠️ 내일 05:30 기상 → 06:30 호텔 로비 대기 (메르시파리 픽업)' },
    ],
  },
  {
  ...
  },
  {
    ...
    food: '늦은 브런치 · Pink Mamma 또는 가벼운 저녁', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
...
export const BUDGET: BudgetItem[] = [
  ...
  },
  {
    ...
    breakdown: [
      ...
      { label: '🇫🇷 파리 Hampton By Hilton Saint Ouen (7/2-7/8, 6박, 3명)', amt: 2949756, status: 'confirmed', note: '✅ 예매완료 · Saint-Ouen (파리 北 인접, Métro 14/RER C) · ⚠️ 원래 Hampton By Hilton Saint Ouen에서 변경' },
...
export const CHECKLIST: ChecklistCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: '🖼️ 루브르 박물관 ✅ 예매완료 (10:10 + 🎧 한국어 오디오 가이드)',
        day: 'Day 23', date: '7/4 (토)', target: '👨‍👩‍👦 가족', count: '3인', price: '€22/인 × 3 = €66 + 오디오 €15 (~₩145K)', status: 'completed',
        note: '✅ 예매완료 · 10:10 시간 슬롯 · 🎧 한국어 오디오 가이드 입장 후 대여 (€5/인) · ⚠️ 도슨트 X = 개인 티켓 사용 가능 (그룹 투어는 별도 티켓 필요) · 동선: 모나리자(Denon) → 비너스·니케 → 다비드 → 이집트관 · Porte des Lions 줄 짧음',
