...
export const BUDGET: BudgetItem[] = [
  ...
  {
    id: 'accommodation', cat: '🏨 숙소', amt: '₩8,466,550', amtNum: 8466550,
    detail: '포르토 2박 + 카미노 Day 1 (Costa Verde) + 카미노 Day 2 (Ofir) + 산티아고 1박 + 둘째 6/23 1박 + 루체른 2박 + 체르마트 2박 + 인터라켄 2박 + 캠브리지 1박 + 파리 7박 예매완료 ✅ (총 20박 확정 ₩7,766,550) · 카미노 잔여 7박 ₩700,000 (사립 펜션 평균 가정)',
    pct: 23, color: '#EA580C',
    breakdown: [
      ...
      { label: '🐚 카미노 잔여 7박 (부부) — 미예매', amt: 700000, status: 'pending', note: '사립 펜션 평균 ~₩100k/박 × 7박 (Viana·Caminha·Tui·Redondela·Pontevedra·Caldas·Padrón)' },
