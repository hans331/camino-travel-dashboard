...
export const SCHEDULE: DayData[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '09:10-09:30', emoji: '🚇', label: 'Saint-Ouen (Métro 14) → Pyramides 직행 + 도보 5분 → 루브르', status: 'pending', detail: '⭐ ~20분 (Métro 14 자동 열차, 빠름) · Pyramides 역이 루브르 코앞 · Navigo 또는 €1.85×3' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '13:30-14:00', emoji: '🚇', label: 'Saint-Ouen (Métro 13) → Place de Clichy → Métro 2 → Blanche (몽마르뜨)', status: 'pending', detail: '~25분 · Blanche 역에서 도보 10분 사크레쾨르 방향 오르막' },
