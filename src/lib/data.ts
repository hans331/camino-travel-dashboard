...
export const SCHEDULE: DayData[] = [
  ...
  {
    day: 24, date: '7/5 (일)', phase: 'paris', title: '🎨 l\'Orangerie + ⛪ 몽마르뜨·사크레쾨르 (7/6 메르시파리 대비)',
    icon: '⛪', desc: '⭐ 오전 l\'Orangerie 모네 수련 → Tuileries 정원 → 점심 → 오후 몽마르뜨 언덕 → 사크레쾨르 대성당 + 예술가 광장 → 몽마르뜨 저녁 → 사크레쾨르 야경 (일몰 21:55) → 22시 호텔. ⚠️ 7/6 메르시파리 05:30 기상 대비.',
    food: '점심 마레·생제르맹 · 저녁 몽마르뜨 (Pink Mamma 또는 Bouillon Pigalle)', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
    lat: 48.8867, lng: 2.3431,
    transit: '🚇 Métro 14 (Saint-Ouen 직결) → Madeleine → 도보; 오후 Métro 12 → Abbesses (몽마르뜨)',
    restaurants: ['Pink Mamma (몽마르뜨, 이탈리안 핫플)', 'Bouillon Pigalle (전통 가성비)', 'La Maison Rose (몽마르뜨 상징 카페)'],
    timeline: [
      ...
      { time: '13:00-14:30', emoji: '🍽️', label: '🍽️ 점심 — 생제르맹 또는 튈르리 근처', status: 'pending', detail: 'Café de Flore (생제르맹 사르트르 단골) · Café Marly (루브르 옆) · Angelina (Rivoli 몽블랑)' },
      { time: '14:30-15:15', emoji: '🚇', label: '점심 → 몽마르뜨 이동 (Métro 12 Abbesses)', status: 'pending', detail: 'Concorde → Métro 12 직결 → Abbesses (약 20분) · Abbesses = 몽마르뜨 진입 역' },
      { time: '15:15-16:00', emoji: '🚶', label: '⭐ 몽마르뜨 언덕 진입 — Wall of Love + 계단', status: 'pending', detail: 'Le Mur des Je t\'aime (사랑의 벽, 250개 언어) · 아멜리에 배경지 좁은 골목 · 오르막 조심' },
      { time: '16:00-17:15', emoji: '⛪', label: '⛪ ⭐ 사크레쾨르 대성당 + 파리 전경', status: 'pending', detail: '⭐ 흰 대리석 대성당 · 파리 NW 전경 (탑 오르기 €7 옵션) · 내부 무료 입장' },
      { time: '17:15-18:15', emoji: '🎨', label: '🎨 Place du Tertre (예술가 광장) — 초상화·캐리커처', status: 'pending', detail: '거리 화가들 多 · 즉석 초상화 €20-30 (선택) · 사진 명소' },
      { time: '18:15-18:45', emoji: '☕', label: '☕ La Maison Rose 또는 몽마르뜨 골목 카페', status: 'pending', detail: '유명 핑크 카페 · 사진 명소' },
      { time: '18:45-20:30', emoji: '🍽️', label: '🍽️ ⭐ 몽마르뜨 저녁 (Pink Mamma 또는 Bouillon Pigalle)', status: 'pending', detail: '⭐ Pink Mamma (Big Mamma 그룹 이탈리안, 핫플, 예약 필수) · Bouillon Pigalle (전통 가성비 €12-18) · Le Consulat (몽마르뜨 상징)' },
      { time: '20:30-21:30', emoji: '🌅', label: '🌅 ⭐⭐ 사크레쾨르 야경 — 일몰 21:55', status: 'pending', detail: '⭐ 저녁 → 밤 전환 시간, 사크레쾨르 조명 켜지고 파리 전경 야경 · 야외 계단에 앉아서 마무리' },
      { time: '21:30-22:15', emoji: '🚇', label: '호텔로 이동 — Métro 12 Abbesses → 환승', status: 'pending', detail: 'Abbesses → Marcadet-Poissonniers → Métro 4 → Marx Dormoy → Métro 12 다시 X · 대안: Uber 직행 €20 (더 빠름)' },
      { time: '22:15-22:30', emoji: '🏨', label: '🏨 호텔 도착 + 7/6 데이팩 최종 점검', status: 'pending', detail: '⭐ 카메라·우산·자켓·간식·물·SPF·선글라스·현금 (입장료 €87 + 픽업비 €40 + 점심)' },
      { time: '22:30', emoji: '📱', label: '📱 메르시파리 카톡 — 06:30 픽업 시간 재확인', status: 'pending' },
      { time: '23:00', emoji: '🛌', label: '⭐ 취침', status: 'pending', detail: '⚠️ 내일 05:30 기상 → 06:30 호텔 로비 대기 (메르시파리 픽업)' },
    ],
  },
  {
  ...
  {
    day: 26, date: '7/7 (화)', phase: 'paris', title: '⛪ 노트르담 재개관 + 시테섬 + 라탱지구 (회복일)',
    icon: '⛪', desc: '⚠️ 전날 메르시파리 새벽 1-2시 복귀 → 오전 회복. 오후 ⛪ 노트르담 대성당 내부 (2024 재개관) + 생트샤펠 + 라탱지구 + 셰익스피어 & 컴퍼니 서점 + 뤽상부르 정원. 저녁 마지막 파리 만찬 + 7/8 출국 짐 정리.',
    food: '늦은 브런치 · 라탱지구·생제르맹 마지막 만찬', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
    lat: 48.8530, lng: 2.3499,
    transit: '🚇 Métro 14 (Saint-Ouen 직결) → Châtelet → 시테섬 도보',
    restaurants: ['Bouillon Chartier (전통 가성비)', 'Le Comptoir du Relais (생제르맹 비스트로)', 'Shakespeare & Company Café (서점 옆)'],
    timeline: [
      { time: '11:00', emoji: '🛌', label: '늦은 기상 (회복 우선)', status: 'pending', detail: '전날 새벽 복귀 · 여유 있게 시작' },
      { time: '12:00-13:30', emoji: '🍳', label: '🍳 브런치 — 호텔 근처 또는 시내', status: 'pending', detail: '천천히 + 컨디션 확인' },
      { time: '13:30-14:00', emoji: '🚇', label: 'Saint-Ouen (Métro 14) → Châtelet → 도보 시테섬', status: 'pending', detail: '~25분 · Métro 14 직결' },
      { time: '14:00-15:30', emoji: '⛪', label: '⛪ ⭐ 노트르담 대성당 내부 (2024 재개관)', status: 'pending', detail: '⚠️ 무료지만 슬롯 예약 필수 · notredamedeparis.fr (2일 전 오픈) 또는 앱 · 재개관 후 폭증' },
      { time: '15:30-16:15', emoji: '⛪', label: '⛪ 생트샤펠 (13세기 스테인드글라스)', status: 'pending', detail: '€13/인 · 노트르담 도보 5분 · 여름 폐관 19:00' },
      { time: '16:15-17:15', emoji: '📚', label: '📚 셰익스피어 & 컴퍼니 서점 + 라탱지구', status: 'pending', detail: '헤밍웨이·조이스 단골 영문 서점 · 골목 산책' },
      { time: '17:15-18:15', emoji: '🌳', label: '🌳 뤽상부르 정원 산책 (파리인의 정원)', status: 'pending', detail: '라탱지구 → 뤽상부르 도보 15분 · 벤치 휴식 · 상원 궁전' },
      { time: '18:30-20:30', emoji: '🍽️', label: '🍽️ ⭐ 마지막 파리 만찬 — 생제르맹 비스트로', status: 'pending', detail: '⭐ Le Comptoir du Relais (예약 필수, 유명 비스트로) · Bouillon Chartier (전통 가성비) · Café de Flore 야경 자리' },
      { time: '20:30-21:00', emoji: '🚇', label: '호텔 복귀 (Métro 14 또는 Uber)', status: 'pending' },
      { time: '21:00-22:30', emoji: '🧳', label: '🧳 ⭐ 7/8 출국 짐 최종 정리 — 캐리어 4개', status: 'pending', detail: '위탁(23kg)·휴대(8kg) × 3 · LH2229 CDG 12:00 · PNR 확인 · 여권·boarding pass 앱 저장' },
...
export const BUDGET: BudgetItem[] = [
  ...
  },
  {
    ...
    breakdown: [
      ...
      { label: '⛪ 노트르담 대성당 내부 (2024 재개관, 무료)', amt: 0, status: 'pending', note: '⚠️ 슬롯 예약 필수 · notredamedeparis.fr (2일 전 오픈) · 7/7 (화) 14:00 슬롯 목표' },
