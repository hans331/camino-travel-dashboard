...
export const SCHEDULE: DayData[] = [
  ...
  },
  {
    ...
    icon: '⛰️',
    desc: '⭐ 새벽 07:00 첫차 후속 — Gornergrat 톱니바퀴 (STP 50% 할인 2등석 CHF 66/인) → 3,089m 정상 알펜글로우 마테호른 + 29개 4,000m 봉우리 + Gorner 빙하. Kulmhotel 3100 정상 카페 → Rotenboden 한 정거장 내려 Riffelsee 트레일 (왕복 1h, 마테호른 반영 인스타 명소 #1) → 11:30 Zermatt 하산. 오후 14시 Sunnegga 푸니쿨라 → Blauherd 케이블카 → 5-호수길 단축 (Stellisee·Grindjisee·Leisee, 2-2.5h). ⚠️ 12시 이후 산정 천둥 risk — 오전 집중, 오후 5-호수길은 천둥 신호 즉시 푸니쿨라 하산. 비 와도 천둥 X면 OK.',
    ...
    timeline: [
      ...
      { time: '07:00', emoji: '🚂', label: 'Gornergrat Bahn 4명 2등석 왕복 (STP 50% 할인 CHF 264 ≈ ₩440K)', status: 'confirmed', detail: '✅ 완료' },
      ...
      { time: '14:15', emoji: '🎫', label: 'Sunnegga+Blauherd 왕복 콤보 4명 구매 (STP 50% CHF 23/인 = CHF 92 ≈ ₩155K)', status: 'pending', detail: '⚠️ Pay in CHF (DCC USD 거절)' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '18:00', emoji: '🚠', label: '🚠 Harderbahn 푸니쿨라 탑승 (8분, 1,322m)', status: 'pending', detail: 'STP 50% 할인 · CHF 18/인 × 4 = CHF 72 · 30분 간격 운행' },
  ...
  {
    day: 19, date: '6/30 (화)', phase: 'london', title: '🛫 스위스 → 영국 → 캠브리지 (가족 4명 함께) ⚠️ 이른 출발 07:00',
    icon: '🛫', desc: '가족 4명 함께 이동 — ⚠️ 06:00 기상, 07:00 체크아웃 → 07:30 Interlaken Ost 기차 → 09:50 ZRH 공항 (2h 15분 버퍼). 12:05 LX332 ZRH → LHR (1h 55m). LHR → 캠브리지 (Elizabeth Line + LNER, ~2.5h). 캠브리지 저녁 도착. 졸업식 전야 가족 만찬.',
    food: '취리히 공항 점심 + 캠브리지 졸업 전야 가족 만찬', stay: '✅ Hyatt Centric Cambridge — 디럭스 패밀리룸 (3명·둘째 본인 학생 숙소)',
    lat: 52.2053, lng: 0.1218,
    transit: '🚂 Interlaken 07:30 → ZRH 공항 09:50 (~2h 20m) · ✈️ LX332 ZRH 12:05 → LHR 13:00 · 🚂 LHR → Cambridge ~2.5h',
    restaurants: ['Midsummer House (미슐랭 2★)', 'Restaurant 22', 'The Eagle (역사적 펍)'],
    timeline: [
      { time: '06:00', emoji: '🛌', label: '🛌 기상 + 빠른 준비', status: 'pending', detail: '⚠️ 국제선 대비 이른 출발' },
      { time: '06:15-06:45', emoji: '🍳', label: '간단 아침 + 짐 최종 점검 (4명 캐리어)', status: 'pending', detail: '위탁 23kg/인 × 4 + 휴대 8kg/인 × 4 · 여권·UK ETA 메일 캡처·PNR XTVN7K·e-ticket 확인' },
      { time: '06:45-07:00', emoji: '🧳', label: '캐리어 정리 + 데이팩 정돈', status: 'pending' },
      { time: '07:00', emoji: '🏨', label: '🏨 Interlaken 호텔 체크아웃', status: 'pending', detail: 'SWEET HOLIDAY HOME NO.1, Rosenstrasse 18 · 체크아웃 07:00-10:00' },
      { time: '07:10-07:25', emoji: '🚶', label: '호텔 → Interlaken Ost 역 도보 (~15분, 캐리어 + 짐)', status: 'pending', detail: '약 800m · 캐리어 굴리며 평지' },
      { time: '07:30', emoji: '🚂', label: '🚂 ⭐ Interlaken Ost → Zurich Flughafen (직행 IC)', status: 'pending', detail: 'STP 무료 · ~2h 20분 · 좌석 자유석 · 우측 추천 (호수·산 풍경)' },
      { time: '09:50', emoji: '🚉', label: '🚉 Zurich Flughafen 도착', status: 'pending', detail: 'SBB 역 → Swiss 체크인 카운터 도보 ~5분 (한 층 위)' },
      { time: '10:00-10:30', emoji: '🎫', label: '🎫 Swiss 체크인 카운터 (위탁 짐 4개)', status: 'pending', detail: '✈️ LX332 · PNR XTVN7K · 위탁 23kg/인 × 4 · 보딩패스 4매 + 위탁 태그' },
      { time: '10:30-11:00', emoji: '🛂', label: '🛂 보안 검색 + 출국 심사 (Schengen 출국)', status: 'pending', detail: '⚠️ Schengen → 영국(non-Schengen) 출국 도장 필요 · 액체 100ml 룰' },
      { time: '11:00-11:30', emoji: '🛍️', label: '🛍️ 면세점 + 라운지 (또는 카페 아침)', status: 'pending', detail: 'Swiss 초콜릿 마지막 쇼핑 OK · 게이트 11:30까지 도착 권장' },
      { time: '11:30', emoji: '🚪', label: '게이트 도착 (이륙 35분 전)', status: 'pending', detail: '⚠️ Boarding 보통 30분 전 시작 · 게이트 번호 보딩패스 확인' },
      { time: '12:05', emoji: '🛫', label: '✈️ LX332 ZRH → LHR 출발 (1h 55m)', status: 'confirmed', detail: 'Swiss · 4명 · 위탁 23kg+휴대 8kg/인 · PNR XTVN7K' },
      { time: '13:00', emoji: '🛬', label: '🛬 LHR T2 도착 (현지 시간, -1h)', status: 'confirmed', detail: '⚠️ UK 입국 — UK ETA 3명 메일 캡처 폰에 준비 · 둘째는 UK 거주자라 별도 줄' },
  ...
  {
    day: 21, date: '7/2 (목)', phase: 'paris', title: '🎨 오르세 미술관 + 🗼 에펠탑 정상 + 트로카데로',
    icon: '🎨', desc: '⭐ 오전 오르세 미술관 (인상파의 성지: 모네·고흐·세잔·드가). 점심 후 시테 섬·라탱지구 산책. 늦은 오후 트로카데로 에펠탑 외부 사진 + ⭐ 에펠탑 정상(Sommet) 엘리베이터 (일몰 + 야경). 22시 Champ de Mars 야경 마무리. ⚠️ 오르세 + 에펠탑 정상은 사전 예매 필요 (오르세 €16, 에펠탑 €29.40).',
    food: '오르세 카페 점심 · 라탱지구 비스트로 저녁 (가벼운 식사 후 에펠탑)', stay: '✅ Clichy 88m² 아파트 — 같은 숙소 연박',
    lat: 48.8600, lng: 2.3266,
    transit: '🚇 Métro 13 → Métro 12/RER C',
    restaurants: ['Café de Flore (생제르맹 명물)', "L'Ami Jean (전통 비스트로)", 'Le Procope (1686년 카페)', '58 Tour Eiffel (에펠탑 1층, 예약 어려움)'],
    timeline: [
      { time: '08:00-08:30', emoji: '🍳', label: 'Clichy 아파트 아침', status: 'pending', detail: '커피 + 크루아상' },
      { time: '08:30-09:15', emoji: '🚇', label: 'Clichy → Solférino (오르세역) — Métro 13 → 12 환승', status: 'pending', detail: '~30-40분' },
      { time: '09:15-09:30', emoji: '🚶', label: '오르세 미술관 입구 + 검색대', status: 'pending', detail: 'Pass holders 줄과 별도' },
      { time: '09:30', emoji: '🎨', label: '🎨 ⭐ 오르세 미술관 첫 입장 (예매 필요)', status: 'pending', detail: '⚠️ 예매 미완료 — musee-orsay.fr · €16/인 × 3 = €48 · 휴관: 월요일 (7/2 목 OK)' },
      { time: '09:30-12:30', emoji: '🖼️', label: '⭐ 인상파 핵심 동선 — 모네·고흐·세잔·드가·르누아르 (5층)', status: 'pending', detail: '⭐ 5층 먼저 (인상파 명작 집중) → 0층 (조각·아르누보) → 2층 (오딜롱 르동, 휘슬러)' },
      { time: '12:30-14:00', emoji: '🍽️', label: '점심 — 오르세 카페 또는 생제르맹 비스트로', status: 'pending', detail: 'Café Campana (오르세 5층, 미술관 안) 또는 Café de Flore (생제르맹, 사르트르·헤밍웨이 단골)' },
      { time: '14:00-15:30', emoji: '🚶', label: '⭐ 시테 섬 산책 — 노트르담 외부 + 생트샤펠 외관', status: 'pending', detail: '⛪ 노트르담 내부는 7/4 별도 일정 · 강 변 산책' },
      { time: '15:30-17:00', emoji: '📚', label: '⭐ 라탱지구 + 셰익스피어 & 컴퍼니 서점', status: 'pending', detail: '헤밍웨이·조이스 단골 영문 서점 + 라탱지구 골목' },
      { time: '17:00-17:30', emoji: '🚇', label: 'Saint-Michel → Trocadéro (Métro 9 또는 RER C)', status: 'pending' },
      { time: '17:30-18:30', emoji: '📸', label: '⭐⭐ Trocadéro 광장 — 에펠탑 정면 + Palais de Chaillot 분수 사진', status: 'pending', detail: '⭐ 파리 NO.1 에펠탑 사진 명소 · 가족 사진 필수 · 일몰 직전 황금 시간' },
      { time: '18:30-18:45', emoji: '🚶', label: 'Pont d\'Iéna 다리 건너 → 에펠탑 Pilier Sud (남쪽 기둥)', status: 'pending', detail: '⚠️ 정상행 엘리베이터 = Sud 또는 Nord 기둥만' },
      { time: '18:45-19:00', emoji: '🎫', label: '에펠탑 입장 + 검색대', status: 'pending', detail: '⚠️ 예매 미완료 — toureiffel.paris · "Lift to top" €29.40/인 × 3 = €88 · 권장 슬롯 18:00-19:00 (일몰 21:55 대비)' },
      { time: '19:00-20:30', emoji: '🗼', label: '🗼 ⭐ 2층 → 정상(Sommet 276m) 엘리베이터 — 황금시간 파리 전경', status: 'pending', detail: '⚠️ 정상 -3-5°C 추움, 얇은 자켓 권장 · 물·간식 미리 (정상 카페 매우 비쌈)' },
      { time: '20:30-22:00', emoji: '🌅', label: '🌅 ⭐⭐ 일몰 (21:55경) + 야경 조명 점등', status: 'pending', detail: '⭐ 매시 정각 5분간 에펠탑 반짝이 조명 (시작 일몰 후)' },
      { time: '22:00-22:30', emoji: '🚶', label: '하산 → Champ de Mars 잔디밭 야경 사진', status: 'pending', detail: '⭐ 잔디밭에 누워서 에펠탑 정면 야경 = 인스타 명소' },
      { time: '22:30-23:00', emoji: '🚇', label: '호텔 복귀 (Uber 권장 야간 €15-20)', status: 'pending' },
      { time: '23:30', emoji: '🛌', label: '취침', status: 'pending', detail: '내일 7/3 베르사유 09:00 출발' },
    ],
  },
  {
    day: 22, date: '7/3 (금)', phase: 'paris', title: '👑 베르사유 궁전 + 트리아농 + 분수쇼 ✅ 예매완료 (10:30 Entrance A)',
    icon: '👑', desc: '⭐ ✅ Billet Passeport 예매완료 (€35 × 3 = €105, Full rate, Chullyoung Choi 명의) · 10:30 슬롯 Entrance A. RER C로 베르사유 (~45분). 10:30 궁전 입장 (11:00 전 입장 필수, 거울의 방·왕실 침전) → 12:00 트리아농 오픈 (Grand·Petit·Queen\'s Hamlet) → 15:00-17:30 정원 + ⭐ Musical Fountains Show 그랜드 피날레. 저녁 파리 복귀 → 마레지구 비스트로.',
    food: '베르사유 정원 카페 점심 + 마레지구 저녁', stay: '✅ Clichy 88m² 아파트 (예매완료) — 같은 숙소 연박',
    lat: 48.8048, lng: 2.1203,
    transit: '🚇 Métro 13 + 🚂 RER C → Versailles Château Rive Gauche (~50분)',
    restaurants: ['Breizh Café (마레, 브르통 갈레트)', "L'As du Fallafel (마레, 전설적 팔라펠)", 'Angelina Café (베르사유 성내 점심)'],
    timeline: [
      { time: '08:30-09:00', emoji: '🍳', label: 'Clichy 아파트 아침', status: 'pending', detail: '커피 + 크루아상 + 과일' },
      { time: '09:00-09:15', emoji: '🚇', label: 'Métro 13 Clichy → 환승', status: 'pending', detail: 'Champ de Mars-Tour Eiffel 또는 Invalides에서 RER C 환승' },
      { time: '09:15-10:15', emoji: '🚂', label: '🚂 RER C → Versailles Château Rive Gauche', status: 'pending', detail: '~45분 · Navigo 1일권 또는 €7.5 편도 × 3' },
      { time: '10:15-10:25', emoji: '🚶', label: '베르사유 역 → 궁전 도보 (~10분)', status: 'pending', detail: 'Entrance A 방향' },
      { time: '10:30', emoji: '👑', label: '👑 ⭐ 베르사유 궁전 입장 (Entrance A) ✅ 예매완료', status: 'confirmed', detail: '✅ Billet Passeport €35 × 3 = €105 · Chullyoung Choi 명의 · ⚠️ 10:30 슬롯 → 11:00 전 입장 필수' },
      { time: '10:30-12:00', emoji: '🏛️', label: '⭐ 궁전 핵심 동선 — 거울의 방·왕실 침전·전쟁의 방', status: 'pending', detail: 'Hall of Mirrors (거울의 방) 먼저 → 인파 폭증 전 사진 확보' },
      ...
      { time: '15:00-17:30', emoji: '⛲', label: '⭐⭐ 정원 산책 + Musical Fountains Show (금요일 운영일!)', status: 'pending', detail: 'Le Nôtre 설계 거대 정원 · Latona·Apollo 분수 · ⭐ 17:30 그랜드 피날레 필관람' },
      ...
      { time: '22:00', emoji: '🏨', label: 'Clichy 아파트 복귀', status: 'pending', detail: 'Métro 또는 Uber (야간 €15-20)' },
    ],
  },
  {
    day: 23, date: '7/4 (토)', phase: 'paris', title: '🖼️ 루브르 박물관 ✅ 10:10 입장 + 마레 + 노트르담',
    icon: '🖼️', desc: '✅ 루브르 10:10 입장 예매완료 · 모나리자·비너스·니케 핵심 작품 동선. 점심 후 마레지구 산책 + 보주 광장 + 피카소 미술관. 늦은 오후 노트르담 + 생트샤펠 + 라탱지구.',
    food: '루브르 카페 점심 · 마레 팔라펠 · 라탱지구 저녁', stay: '✅ Clichy 88m² 아파트 (예매완료) — 같은 숙소 연박',
    lat: 48.8606, lng: 2.3376,
    transit: '🚇 Métro 13 + 1 → Palais Royal-Musée du Louvre',
    restaurants: ['Bouillon Chartier (전통)', "L'As du Fallafel (마레 팔라펠)", 'Café Marly (루브르 카페)'],
    timeline: [
      { time: '08:00-08:45', emoji: '🍳', label: 'Clichy 아파트 아침', status: 'pending' },
      { time: '08:45-09:30', emoji: '🚇', label: 'Métro 13 Clichy → Champs-Élysées-Clemenceau → Métro 1 → Palais Royal-Musée du Louvre', status: 'pending', detail: '~30분 · Navigo 또는 €1.85×3' },
      { time: '09:30-10:00', emoji: '🚶', label: '루브르 입구 대기 + 검색대', status: 'pending', detail: '⭐ Porte des Lions 또는 Carrousel 통로 추천 (Pyramide보다 줄 짧음)' },
      { time: '10:10', emoji: '🖼️', label: '🖼️ ⭐ 루브르 박물관 입장 ✅ 예매완료', status: 'confirmed', detail: '✅ 10:10 시간 슬롯 예매완료 · 3명 · €22/인 × 3 = €66' },
      { time: '10:15-11:00', emoji: '🎨', label: '⭐ 모나리자 (Denon 동, 1층) — 가장 먼저!', status: 'pending', detail: '인파 폭증 전 = 사진 명소' },
      { time: '11:00-12:30', emoji: '🏛️', label: '비너스·니케·라파엘로·다비드·이집트관', status: 'pending', detail: 'Denon 동 → Sully 동 동선' },
      { time: '12:30-13:30', emoji: '🍽️', label: 'Café Marly 또는 Tuileries 정원 피크닉 점심', status: 'pending' },
      { time: '13:30-15:30', emoji: '🚶', label: '⭐ 마레지구 산책 — 보주 광장 + 피카소 미술관 + 마레 거리', status: 'pending', detail: '17세기 귀족 저택가 + 갤러리 多' },
      { time: '15:30-16:30', emoji: '🥙', label: 'L\'As du Fallafel 또는 마레 카페 늦은 간식', status: 'pending' },
      { time: '16:30-17:30', emoji: '⛪', label: '⛪ 노트르담 대성당 + Île de la Cité', status: 'pending', detail: '⚠️ 사전 예약 슬롯 권장 (notredamedeparis.fr, 2일 전 오픈)' },
      { time: '17:30-18:30', emoji: '⛪', label: '⛪ 생트샤펠 (13세기 스테인드글라스)', status: 'pending', detail: '€13/인 · 노트르담 도보 5분' },
      { time: '18:30-19:30', emoji: '🚶', label: '라탱지구 산책 + 셰익스피어 & 컴퍼니 서점', status: 'pending' },
      { time: '19:30-21:30', emoji: '🍽️', label: '🍽️ 라탱지구 또는 마레 저녁', status: 'pending', detail: 'Bouillon Chartier (가성비 전통) 또는 마레 비스트로' },
      { time: '22:00', emoji: '🏨', label: 'Clichy 아파트 복귀', status: 'pending' },
    ],
  },
  {
    day: 24, date: '7/5 (일)', phase: 'paris', title: '🎨 l\'Orangerie + 🏛️ 마레지구 (휴식 모드 — 7/6 메르시파리 대비)',
    icon: '🎨', desc: '⭐ 지베르니는 7/6 메르시파리 패키지에 통합 → 이 날은 가벼운 일정. 오전 늦은 시작 → l\'Orangerie (모네 수련 대벽화 8개) → 마레지구 점심·산책·보주 광장 → 저녁 일찍. ⚠️ 7/6 새벽 5시 기상 대비 22시 취침.',
    food: '마레지구 점심 · 일찍 저녁', stay: '✅ Clichy 88m² 아파트 — 같은 숙소 연박',
    lat: 48.8638, lng: 2.3239,
    transit: '🚇 Métro 내 단거리 이동',
    restaurants: ['Breizh Café (마레 갈레트)', "L'As du Fallafel (팔라펠)", 'Bouillon Pigalle (전통 가성비)'],
    timeline: [
      { time: '09:30-10:30', emoji: '🍳', label: '늦은 아침 + 호텔 휴식', status: 'pending', detail: '컨디션 보존 — 내일 새벽 5시 기상' },
      { time: '10:30-11:00', emoji: '🚇', label: 'Clichy → Concorde (Métro 13 → 1)', status: 'pending' },
      { time: '11:00-12:30', emoji: '🎨', label: '🎨 ⭐ l\'Orangerie — 모네 수련 대벽화 (Nymphéas)', status: 'pending', detail: '€12.50/인 · 8개 거대 캔버스 타원형 방 · 사전 예매 권장 · Tuileries 정원 옆 · 휴관 화요일 (일요일 OK)' },
      { time: '12:30-14:00', emoji: '🍽️', label: '🍽️ 마레지구 점심', status: 'pending', detail: 'Breizh Café 갈레트 또는 L\'As du Fallafel (전설적 팔라펠)' },
      { time: '14:00-16:30', emoji: '🏛️', label: '⭐ 마레지구 산책 — 보주 광장 + 피카소 미술관 + 빅토르 위고 박물관', status: 'pending', detail: '17세기 귀족 저택가 + 갤러리·부티크 · 가볍게 골라서' },
      { time: '16:30-17:30', emoji: '☕', label: '마레 카페 휴식', status: 'pending', detail: 'Café Charlot 또는 노천 카페' },
      { time: '18:00-19:30', emoji: '🍽️', label: '🍽️ 일찍 저녁 식사 (새벽 5시 기상 대비)', status: 'pending', detail: 'Bouillon Pigalle (전통 가성비) 또는 호텔 근처 가벼운 식당' },
      { time: '20:30', emoji: '🏨', label: '🏨 호텔 복귀 + 7/6 데이팩 준비', status: 'pending', detail: '카메라·우산·자켓·간식·물·SPF·선글라스 미리 챙기기' },
      { time: '21:00', emoji: '🚖', label: 'Uber 호텔 → 트로카데로 ETA 사전 체크', status: 'pending', detail: '06:30 Uber 호출 예약 (앱에서 sched ride)' },
      { time: '22:00', emoji: '🛌', label: '⭐ 일찍 취침', status: 'pending', detail: '⚠️ 내일 05:00 기상 → 07:20 트로카데로 집합!' },
    ],
  },
  {
    day: 25, date: '7/6 (월)', phase: 'paris', title: '🏰 메르시파리 패키지 ✅ — 몽생미셀 + 지베르니 + 옹플뢰르 (한국어 가이드 16h)',
    icon: '🏰', desc: '⭐ ✅ 예매완료 (메르시파리 한국어 가이드 투어, 3명, 16시간) · 07:20 트로카데로 집합 → 지베르니 모네 정원 → 옹플뢰르 항구 (또는 고흐마을) → 몽생미셀 일몰 → 새벽 1-2시 호텔 복귀. ⚠️ 입장료 별도 (MSM €16 + 지베르니 €13). 다음날 7/7은 회복일.',
    food: '점심 자유 (€20-30/인) · 몽생미셀 La Mère Poulard 또는 마을 비스트로 저녁 · 차내 간식', stay: '✅ Clichy 88m² 아파트 — 같은 숙소 연박',
    ...
    timeline: [
      { time: '05:00', emoji: '🛌', label: '🛌 기상 + 빠른 준비', status: 'pending' },
      { time: '05:30-06:15', emoji: '🍳', label: '간단 아침 + 데이팩 최종 체크', status: 'pending', detail: '카메라·우산·자켓·간식·물·SPF·선글라스·현금(입장료용)' },
      { time: '06:30', emoji: '🚖', label: '🚖 Uber 호텔 → 트로카데로 (~€20-25, 30-40분)', status: 'pending', detail: 'Clichy(92) → 16구 Trocadéro · Métro 첫차 안전상 X' },
      { time: '07:20', emoji: '🎫', label: '🎫 ⭐ 트로카데로역 2·3번 출구, Café le Malakoff 앞 집합 ✅', status: 'confirmed', detail: '✅ 메르시파리 예매완료 · 가이드 미팅 + 수신기·이어폰 수령' },
      { time: '07:30', emoji: '🚐', label: '🚐 차량 출발 (한국어 가이드)', status: 'pending' },
      { time: '08:20-12:30', emoji: '🌻', label: '🌻 ⭐ 지베르니 모네 정원 + 옹플뢰르 (또는 고흐마을)', status: 'pending', detail: '⚠️ 지베르니 입장료 €13/인 별도 결제 · 모네의 집·수련 연못·일본식 다리 · 점심 자유 (€20-30/인)' },
      ...
      { time: '16:50-19:00', emoji: '🏛️', label: '🏛️ ⭐ 수도원 입장 + 자유 시간', status: 'pending', detail: '⚠️ 수도원 입장료 €16/인 별도 결제 · 가이드 동행' },
      { time: '19:00-21:00', emoji: '🍽️', label: '🍽️ 저녁 식사 (자유, €20-30/인)', status: 'pending', detail: '⭐ La Mère Poulard 명물 오믈렛 (€40+, 비쌈) 또는 마을 비스트로 (€20-25, 가성비)' },
      ...
      { time: '01:00-02:00+1', emoji: '🏨', label: '🏨 ⚠️ 새벽 1-2시 호텔 도착 (메르시파리 샌딩)', status: 'pending', detail: '⚠️ Clichy 92구 = 1-20구 외 → 추가 샌딩 요금 €10-20 가능' },
      { time: '02:30', emoji: '🛌', label: '🛌 취침 (다음날 7/7 회복일)', status: 'pending' },
    ],
  },
  {
    day: 26, date: '7/7 (화)', phase: 'paris', title: '😴 회복일 + 🎭 몽마르뜨 가벼운 일정 (7/6 새벽 복귀 후)',
    icon: '😴', desc: '⚠️ 전날 메르시파리 새벽 1-2시 복귀 → 회복 우선. 늦은 기상 + 호텔 휴식. 오후 가벼운 몽마르뜨·사크레쾨르 + 예술가 광장 + 마카롱(Pierre Hermé). 저녁 일찍 + 7/8 출국 짐 정리. ⚠️ l\'Orangerie는 화요일 휴관 (7/5에 미리 본 일정).',
    food: '늦은 브런치 · Pink Mamma 또는 가벼운 저녁', stay: '✅ Clichy 88m² 아파트 — 같은 숙소 연박',
    lat: 48.8867, lng: 2.3431,
    transit: '🚇 호텔 → 몽마르뜨 Métro 짧은 거리',
    restaurants: ['Pink Mamma (몽마르뜨, 이탈리안)', 'Pierre Hermé 마카롱', 'Bouillon Pigalle (가성비)'],
    timeline: [
      { time: '10:30', emoji: '🛌', label: '늦은 기상 (회복 우선)', status: 'pending' },
      { time: '11:30-13:00', emoji: '🍳', label: '🍳 호텔 근처 또는 마레 브런치', status: 'pending', detail: '천천히 + 컨디션 보기' },
      { time: '13:30-14:00', emoji: '🚇', label: 'Métro 13 → Abbesses (몽마르뜨)', status: 'pending' },
      { time: '14:00-16:00', emoji: '⛪', label: '⭐ 사크레쾨르 대성당 + 몽마르뜨 언덕', status: 'pending', detail: '파리 NW 전경 + 예술가 마을 분위기' },
      { time: '16:00-17:00', emoji: '🎨', label: 'Place du Tertre (예술가 광장) — 초상화·캐리커처', status: 'pending', detail: '거리 화가들 多 · 사진 명소' },
      { time: '17:00-18:00', emoji: '🍰', label: '☕ Pierre Hermé 마카롱 (마지막 디저트)', status: 'pending', detail: '⭐ 한국 선물용 박스 구매' },
      { time: '18:30-20:00', emoji: '🍽️', label: '🍽️ 마지막 파리 만찬', status: 'pending', detail: 'Pink Mamma (몽마르뜨, 핫플) 또는 Bouillon Pigalle (가성비 전통)' },
      { time: '20:30-21:00', emoji: '🏨', label: '호텔 복귀', status: 'pending' },
      { time: '21:00-22:30', emoji: '🧳', label: '🧳 ⭐ 7/8 출국 짐 정리 — 캐리어 4개', status: 'pending', detail: '위탁(23kg)·휴대(8kg) × 3 · LH2229 CDG 12:00 · PNR 확인' },
      { time: '22:30', emoji: '🛌', label: '취침', status: 'pending', detail: '내일 06:30 기상 → 08:00 체크아웃 → CDG 10:30 도착 목표' },
    ],
  },
  {
...
export const BUDGET: BudgetItem[] = [
  ...
  },
  {
    ...
    breakdown: [
      ...
      { label: '🏔️ 융프라우요호 × 4 ✅', amt: 1300000, status: 'confirmed', note: '✅ jungfrau.ch #306398 · 08:04 Interlaken Ost · STP 2nd class 할인' },
      { label: '👑 베르사유 Passport ✅ × 3', amt: 185000, status: 'confirmed', note: '✅ 예매완료 · Billet Passeport €35/인 × 3 = €105 · 7/3 (금) 10:30 Entrance A · Chullyoung Choi 명의' },
      { label: '🖼️ 루브르 박물관 ✅ × 3', amt: 118000, status: 'confirmed', note: '✅ 예매완료 · 7/4 (토) 10:10 입장 · €22/인 × 3 = €66' },
      ...
      { label: '🇫🇷 파리 3개 명소 × 3 (오르세·에펠탑·l\'Orangerie)', amt: 240000, status: 'pending', note: '에펠탑 정상 + 오르세 + l\'Orangerie 잔여 (가장 시급: 에펠탑)' },
    ],
  },
  {
...
export const TRANSPORTS: Transport[] = [
  ...
  { route: '인터라켄 → 융프라우요호 왕복 (6/29)', method: '🚂 산악열차 (Eiger Express)', time: '08:04→09:13(정상 09:45경) · 13:45→14:51 복귀', price: 'CHF 232/인 × 4 (STP 25%)', tip: '✅ 예매완료 #306398 · 좌석예약 (10분 전 도착) · 4명 PDF 체크리스트 첨부' },
  ...
  { route: '파리 → 베르사유 왕복 (7/3)', method: '🚂 RER C → Château Rive Gauche', time: '45분', price: '€7.5 편도', tip: '✅ 베르사유 Passport 예매완료 (€35×3, 10:30 Entrance A) · 09:15 RER 탑승 → 10:15 도착 → 10:30 입장' },
  { route: '🏰 ✅ 메르시파리 패키지 (7/6) — 몽생미셀+지베르니+옹플뢰르', method: '🚐 한국어 가이드 차량 16h', time: '07:20 출발 → 새벽 1-2시 복귀', price: '239,000원/인 × 3', tip: '✅ 예매완료 · 트로카데로 2·3번 출구 Café le Malakoff 앞 집합 · 입장료 별도 (MSM €16 + 지베르니 €13)' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '⛰️ Gornergrat 톱니바퀴열차', day: 'Day 16', date: '6/27', target: '👨‍👩‍👦‍👦 가족', count: '4인', price: 'CHF 132/인', note: '마테호른 클래식 뷰', status: 'pending' },
      {
        ...
        day: 'Day 18', date: '6/29 (월)', target: '👨‍👩‍👦‍👦 가족', count: '4인', code: '#306398', price: 'CHF 232/인 (STP 25%)', status: 'completed',
        ...
        booking: { ref: '306398', platform: 'jungfrau.ch', accessNote: '⚠️ 출발 10분 전 도착 필수 · "with seat reservation" 파란 표지판 따라가기 · QR 4명 분 e-ticket 체크리스트 첨부 PDF' },
      },
      { label: '🚣 캠브리지 펀팅 보트', day: 'Day 19-20', date: '6/30 or 7/1', target: '👨‍👩‍👦‍👦 가족', count: '4인', status: 'pending' },
      { label: '🎨 오르세 미술관 (인상파 핵심) ⚠️ 예매 필요', day: 'Day 21', date: '7/2 (목)', target: '👨‍👩‍👦 가족', count: '3인', price: '€16/인 × 3 = €48 (~₩85K)', note: '⚠️ musee-orsay.fr 사전 예매 · 09:30 첫 입장 권장 · 휴관: 월요일 (7/2 목 OK)', status: 'pending', link: { url: 'https://www.musee-orsay.fr/en', label: '오르세 공식' } },
      { label: '🗼 에펠탑 정상(Sommet) ⚠️ 예매 시급', day: 'Day 21', date: '7/2 (목)', target: '👨‍👩‍👦 가족', count: '3인', price: '€29.40/인 × 3 = €88 (~₩155K)', note: '⚠️ toureiffel.paris 사전 예매 · "Lift to top" 선택 · 권장 슬롯 18:00 (일몰 21:55 + 야경 4-5h 체류) · 정상 슬롯 매진 가장 빠름!', status: 'pending', link: { url: 'https://www.toureiffel.paris/en', label: '에펠탑 공식' } },
      {
        ...
        note: '✅ 예매완료 · Billet Passeport (Full rate) · 10:30 시간 슬롯 · Entrance A · 명의 Chullyoung Choi · ⚠️ 11:00 전 궁전 입장 필수 · 트리아농 12:00 오픈 · 금요일 = Musical Fountains Show 운영일 (17:30 그랜드 피날레)',
      ...
      {
        label: '🖼️ 루브르 박물관 ✅ 예매완료 (10:10)',
        day: 'Day 23', date: '7/4 (토)', target: '👨‍👩‍👦 가족', count: '3인', price: '€22/인 × 3 = €66 (~₩118K)', status: 'completed',
        note: '✅ 예매완료 · 10:10 시간 슬롯 · 권장 동선: 모나리자(Denon) → 비너스·니케 → 다비드 → 이집트관 · ⚠️ Pyramide보다 Porte des Lions 줄 짧음',
        link: { url: 'https://www.louvre.fr/en', label: '루브르 공식' },
      },
      {
        label: '🏰 메르시파리 패키지 ✅ — 몽생미셀+지베르니+옹플뢰르 (한국어 가이드 16h)',
        day: 'Day 25', date: '7/6 (월)', target: '👨‍👩‍👦 가족', count: '3인', price: '239,000원/인 × 3 = ₩717K', status: 'completed',
        note: '✅ 예매완료 · 07:20 트로카데로 집합 (2·3번 출구 Café le Malakoff 앞) · 한국어 가이드 + 차량 + 숙소 샌딩 · ⚠️ 입장료 (MSM €16 + 지베르니 €13) 별도 · ⚠️ 새벽 1-2시 복귀 · Clichy 92구 샌딩 추가요금 가능',
      ...
      { label: '🎨 l\'Orangerie (모네 수련 대벽화 8개)', day: 'Day 24', date: '7/5 (일)', target: '👨‍👩‍👦 가족', count: '3인', price: '€12.50/인 × 3 = €37.50 (~₩67K)', note: '⚠️ musee-orangerie.fr 사전 예매 권장 · 11:00 슬롯 · ⚠️ 화요일 휴관 (7/7 ❌ → 7/5 일요일로 이동) · Tuileries 정원 옆', status: 'pending', link: { url: 'https://www.musee-orangerie.fr/en', label: 'l\'Orangerie 공식' } },
