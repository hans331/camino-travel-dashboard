...
export const SCHEDULE: DayData[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '14:00-15:00', emoji: '🍽️', label: 'Café Marly 또는 Tuileries 정원 피크닉 점심', status: 'pending', detail: '루브르 관람 후 여유' },
      { time: '15:00-17:00', emoji: '🚶', label: '⭐ 마레지구 산책 — 보주 광장 + 피카소 미술관 + 마레 거리', status: 'pending', detail: '17세기 귀족 저택가 + 갤러리 多' },
      { time: '17:00-17:45', emoji: '🥙', label: 'L\'As du Fallafel 또는 마레 카페 늦은 간식', status: 'pending' },
      { time: '17:45-18:30', emoji: '⛪', label: '⛪ 생트샤펠 (13세기 스테인드글라스)', status: 'pending', detail: '€13/인 · 여름 폐관 19:00 · 마레→생트샤펠 도보 15분' },
      { time: '18:30-19:30', emoji: '⛪', label: '⛪ 노트르담 대성당 외부 + Île de la Cité 산책', status: 'pending', detail: '⚠️ 내부 사전 예약 슬롯 있으면 사용 · 없으면 외부만 (18:30 이후 대부분 슬롯 마감)' },
      { time: '19:30-20:30', emoji: '🚶', label: '라탱지구 산책 + 셰익스피어 & 컴퍼니 서점', status: 'pending' },
      { time: '20:30-22:00', emoji: '🍽️', label: '🍽️ 라탱지구 또는 마레 저녁', status: 'pending', detail: 'Bouillon Chartier (가성비 전통) 또는 마레 비스트로' },
      { time: '22:30', emoji: '🏨', label: 'Hampton By Hilton Saint Ouen 복귀', status: 'pending' },
    ],
  },
  {
