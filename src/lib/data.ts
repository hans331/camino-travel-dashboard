...
export const SCHEDULE: DayData[] = [
  ...
  {
    day: 8, date: '6/19 (금)', phase: 'camino', title: '카미노 Day 6 (중앙): Tui → Redondela ⚠️ 31km',
  ...
  {
    day: 9, date: '6/20 (토)', phase: 'camino', title: '카미노 Day 7 (중앙): Redondela → Pontevedra',
...
export const BUDGET: BudgetItem[] = [
  ...
  {
    id: 'accommodation', cat: '🏨 숙소', amt: '₩8,747,181', amtNum: 8747181,
    detail: '포르토 2박 + 카미노 Day 1-5 (Costa Verde·Ofir·Areias Claras·A Guarda Convento·Tui Amoriño) + 산티아고 1박 + 둘째 6/23 1박 + 루체른 2박 + 체르마트 2박 + 인터라켄 2박 + 캠브리지 1박 + 파리 7박 예매완료 ✅ (총 23박 확정 ₩8,347,181) · 카미노 잔여 4박 ₩400,000 (사립 펜션 평균 가정)',
    pct: 23, color: '#EA580C',
    breakdown: [
      ...
      { label: '🐚 카미노 잔여 4박 (부부) — 미예매', amt: 400000, status: 'pending', note: '사립 펜션 평균 ~₩100k/박 × 4박 (Redondela·Pontevedra·Caldas·Padrón)' },
  ...
  },
  {
    ...
    pct: 2, color: '#C2185B',
    breakdown: [
      { label: '🇬🇧 UK ETA × 3명 (둘째 영국 거주, 불필요)', amt: 108000, status: 'pending', note: '£20×3 = £60 (2026-04 £16→£20 인상)' },
