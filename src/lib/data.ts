...
export const BUDGET: BudgetItem[] = [
  {
    ...
    detail: '실제 항공 결제 (현대·토스카드) — 예매값과 대조',
    pct: 26, color: '#2563EB',
    actual: 14112420,
    settleNote: '결산 ₩14,112,420 — 루프트한자·유로스타·부엘링 수수료·6/30 결항 재발권 스위스항공(현대) + SWISS·대한항공(토스). 예산 대비 +₩2.1M (결항 재발권 영향)',
    breakdown: [
      { label: "SWISS INTL AIRLINES", amt: 1020526, status: "confirmed", note: "06/03 · Toss · 스위스항공(결항 재발권/추가)" },
      { label: "DEUTSCHE LUFTHANSA AG", amt: 4268759, status: "confirmed", note: "06/04 · 현대 · 루프트한자 항공권" },
      { label: "대한항공 국제선", amt: 1273500, status: "confirmed", note: "06/04 · Toss · 대한항공(큰아들)" },
      { label: "SWISS INTL AIRLINES", amt: 166906, status: "confirmed", note: "06/04 · Toss · 스위스항공(결항 재발권/추가)" },
      { label: "LUFTHANSA ×8건", amt: 3028781, status: "confirmed", note: "06/08 · 현대 · 루프트한자 항공권" },
      { label: "SWISS 부대 ×8건", amt: 1974325, status: "confirmed", note: "06/09 · Toss · 스위스항공(결항 재발권/추가)" },
      { label: "EUROSTAR", amt: 626439, status: "confirmed", note: "06/09 · 현대 · 유로스타(런던→파리)" },
      { label: "Vueling Airlines", amt: 111854, status: "confirmed", note: "06/10 · 현대 · 부엘링 이름변경 수수료" },
      { label: "LX EMV VI SWITZERLAND", amt: 1089833, status: "confirmed", note: "06/30 · 현대 · 스위스항공(결항 재발권/추가)" },
      { label: "SWISSINTAIR 7242349587137", amt: 395048, status: "confirmed", note: "07/03 · 현대 · 스위스항공(결항 재발권/추가)" },
      { label: "SWISSINTAIR", amt: 156449, status: "confirmed", note: "07/03 · 현대 · 스위스항공(결항 재발권/추가)" },
    ],
  },
  {
    id: 'accommodation', cat: '🏨 숙소', amt: '₩9,235,503', amtNum: 9235503,
    detail: '부킹닷컴 완료 20건 + 인터라켄 현금 + 파리(아내)',
    pct: 23, color: '#EA580C',
    actual: 11240652,
    settleNote: '결산 ₩11,240,652 — 부킹 20건 ₩10,043,848(파리 ₩2.82M 아내 결제) + 인터라켄 2박 ₩1,196,804(실수취소→현금 재결제). Belvoir 1박 추가 등 예산 대비 +₩2.0M',
    breakdown: [
      { label: "네이버페이(SANTA RITA)", amt: 354271, status: "confirmed", note: "06/10 · 현대 · 숙박 선결제(부킹)" },
      { label: "Booking ×9 선결제", amt: 4095171, status: "confirmed", note: "06/11 · 현대 · 숙박 선결제(부킹)" },
      { label: "HOTEL PARQUE DO RIO", amt: 140717, status: "confirmed", note: "06/14 · 현대 · 숙박 현장결제" },
      { label: "Booking.com Hotel", amt: 271897, status: "confirmed", note: "06/15 · 현대 · 숙박 선결제(부킹)" },
      { label: "HOTEL SAN BENITO", amt: 220011, status: "confirmed", note: "06/17 · 현대 · 숙박 현장결제" },
      { label: "Booking com", amt: 161184, status: "confirmed", note: "06/20 · 현대 · 숙박 선결제(부킹)" },
      { label: "CASA RURAL TORRE DO RIO", amt: 475394, status: "confirmed", note: "06/22 · 현대 · 숙박 현장결제" },
      { label: "PAZO DE LESTROVE", amt: 6385, status: "confirmed", note: "06/23 · 현대 · 숙박 부대(시티택스)" },
      { label: "LIBREDON", amt: 5891, status: "confirmed", note: "06/23 · 현대 · 숙박 부대(시티택스)" },
      { label: "인터라켄 SWEET HOLIDAY HOME (2박)", amt: 1196804, status: "confirmed", note: "06/28 · 현금 · 인터라켄 숙박(현금 재결제)" },
      { label: "BKG*Hotel(파리)", amt: 599621, status: "confirmed", note: "07/01 · 현대 · 숙박 선결제(부킹)" },
      { label: "HOTEL BELVOIR RUSCHLIKON", amt: 13605, status: "confirmed", note: "07/01 · 현대 · 취리히 벨부아(결항 1박 추가)" },
      { label: "파리 숙소 (Hampton 본관 등)", amt: 2823709, status: "confirmed", note: "07/02 · 아내 · 파리 생투앵 호텔(아내 결제)" },
      { label: "SASU Societe hoteliere", amt: 29749, status: "confirmed", note: "07/02 · 현대 · 숙박 부대(시티택스)" },
      { label: "Hampton by Hilton Paris", amt: 846243, status: "confirmed", note: "07/03 · 현대 · 파리 생투앵" },
    ],
  },
  {
    id: 'food', cat: '🍽️ 식비', amt: '₩7,600,000', amtNum: 7600000,
    detail: '실제 식비 (마트·식당·미식회) · 인당 카미노47K/스위스35K/파리60K',
    pct: 17, color: '#16A34A',
    actual: 3463638,
    settleNote: '결산 ₩3,463,638 — 카미노(알베르게·마트)+스위스(Coop·Migros 자취)+파리 식당+김어준 미식회 ₩150K. 예산 대비 −₩4.14M 절감(자취 효과)',
    breakdown: [
      { label: "Ondo korean kitchen", amt: 85368, status: "confirmed", note: "06/13 · VIVA · 현지 식당 외식" },
      { label: "Autogrill Deutschland", amt: 9245, status: "confirmed", note: "06/13 · 현대 · 이동 중 식사" },
      { label: "맥도날드", amt: 36378, status: "confirmed", note: "06/14 · VIVA · 카페·간편식" },
      { label: "CONTINENTE", amt: 4648, status: "confirmed", note: "06/14 · VIVA · 장보기·자취(마트)" },
      { label: "RAMEN CASA E SUSHI", amt: 63857, status: "confirmed", note: "06/15 · VIVA · 현지 식당 외식" },
      { label: "BAR LADERCA", amt: 11921, status: "confirmed", note: "06/15 · VIVA · 현지 식당 외식" },
      { label: "BAR LADERCA", amt: 8714, status: "confirmed", note: "06/15 · VIVA · 현지 식당 외식" },
      { label: "HORUS OFIR", amt: 86586, status: "confirmed", note: "06/16 · VIVA · 현지 식당 외식" },
      { label: "SUPERMERCADO ALMEIDA", amt: 32731, status: "confirmed", note: "06/16 · VIVA · 장보기·자취(마트)" },
      { label: "HTL CONVENTO CABANAS", amt: 68935, status: "confirmed", note: "06/17 · 현대 · 현지 식당 외식" },
      { label: "MARDENTRO", amt: 68391, status: "confirmed", note: "06/17 · VIVA · 현지 식당 외식" },
      { label: "XEREMPREGA", amt: 6231, status: "confirmed", note: "06/17 · VIVA · 현지 식당 외식" },
      { label: "RESTAURANTE VALLADEIRO", amt: 156204, status: "confirmed", note: "06/18 · VIVA · 현지 식당 외식" },
      { label: "CASA DI MILI", amt: 53729, status: "confirmed", note: "06/19 · VIVA · 현지 식당 외식" },
      { label: "FROIZ", amt: 17801, status: "confirmed", note: "06/19 · VIVA · 장보기·자취(마트)" },
      { label: "A TITA BELEN", amt: 28462, status: "confirmed", note: "06/20 · 현대 · 현지 식당 외식" },
      { label: "A TITA BELEN", amt: 9792, status: "confirmed", note: "06/20 · 현대 · 현지 식당 외식" },
      { label: "O FARO", amt: 5360, status: "confirmed", note: "06/20 · 현대 · 현지 식당 외식" },
      { label: "RODEO CAFE BAR", amt: 10148, status: "confirmed", note: "06/21 · 현대 · 현지 식당 외식" },
      { label: "FOGAR DO PEREGRINO", amt: 39057, status: "confirmed", note: "06/22 · 현대 · 현지 식당 외식" },
      { label: "FOGAR DO PEREGRINO", amt: 5674, status: "confirmed", note: "06/22 · 현대 · 현지 식당 외식" },
      { label: "RESTAURANTE PAZO DE LESTR", amt: 140796, status: "confirmed", note: "06/23 · 현대 · 현지 식당 외식" },
      { label: "NUMARU REST COREANO", amt: 54404, status: "confirmed", note: "06/23 · 현대 · 현지 식당 외식" },
      { label: "8 CONVENIENCE STORE", amt: 22367, status: "confirmed", note: "06/23 · 현대 · 장보기·자취(마트)" },
      { label: "CAFETERIA CASA DA CULTURA", amt: 6419, status: "confirmed", note: "06/23 · 현대 · 현지 식당 외식" },
      { label: "O PALLOTE", amt: 71175, status: "confirmed", note: "06/24 · 현대 · 현지 식당 외식" },
      { label: "TAVOLAGO/MS GOTTHARD", amt: 32945, status: "confirmed", note: "06/25 · 현대 · 명소 레스토랑" },
      { label: "RESTAURANT CHALET", amt: 21205, status: "confirmed", note: "06/25 · 현대 · 현지 식당 외식" },
      { label: "TAVOLAGO/MS GOTTHARD", amt: 4817, status: "confirmed", note: "06/25 · 현대 · 명소 레스토랑" },
      { label: "COOP-1986 LU", amt: 171309, status: "confirmed", note: "06/26 · 현대 · 장보기·자취(마트)" },
      { label: "COOP PRONTO 4131", amt: 30786, status: "confirmed", note: "06/26 · 현대 · 장보기·자취(마트)" },
      { label: "CAFFE SPETTACOLO", amt: 11188, status: "confirmed", note: "06/26 · 현대 · 카페·간편식" },
      { label: "ADM WELLE 7 RETAIL", amt: 1934, status: "confirmed", note: "06/26 · 현대 · 장보기·자취(마트)" },
      { label: "COOP-2215 ZERMATT", amt: 84370, status: "confirmed", note: "06/27 · 현대 · 장보기·자취(마트)" },
      { label: "FIKOMA AG", amt: 34828, status: "confirmed", note: "06/27 · 현대 · 현지 식당 외식" },
      { label: "LS Matterhorn Group", amt: 22828, status: "confirmed", note: "06/27 · 현대 · 현지 식당 외식" },
      { label: "MIGROS MM ZERMATT", amt: 10251, status: "confirmed", note: "06/27 · 현대 · 장보기·자취(마트)" },
      { label: "COOP-2215 ZERMATT", amt: 1154, status: "confirmed", note: "06/27 · 현대 · 장보기·자취(마트)" },
      { label: "McDonalds Amacker", amt: 122507, status: "confirmed", note: "06/28 · 현대 · 카페·간편식" },
      { label: "COOP PRONTO 4131", amt: 48575, status: "confirmed", note: "06/28 · 현대 · 장보기·자취(마트)" },
      { label: "COOP-2215 ZERMATT", amt: 22344, status: "confirmed", note: "06/28 · 현대 · 장보기·자취(마트)" },
      { label: "ELVETINO AG", amt: 20519, status: "confirmed", note: "06/28 · 현대 · 이동 중 식사" },
      { label: "JUNGFRAU GASTRONOMIE", amt: 161614, status: "confirmed", note: "06/29 · 현대 · 명소 레스토랑" },
      { label: "BASE CAFE", amt: 9618, status: "confirmed", note: "06/29 · 현대 · 카페·간편식" },
      { label: "ELVETINO AG", amt: 55647, status: "confirmed", note: "06/30 · 현대 · 이동 중 식사" },
      { label: "COOP-4014 LAUTERBRUNNEN", amt: 21252, status: "confirmed", note: "06/30 · 현대 · 장보기·자취(마트)" },
      { label: "COOP-4014 LAUTERBRUNNEN", amt: 19143, status: "confirmed", note: "06/30 · 현대 · 장보기·자취(마트)" },
      { label: "Pret a Manger", amt: 22031, status: "confirmed", note: "07/01 · 현대 · 카페·간편식" },
      { label: "김어준 금요미식회 저녁", amt: 150000, status: "confirmed", note: "07/02 · 현금 · 김어준 금요미식회" },
      { label: "LS MOULIN DE SEOUL", amt: 99597, status: "confirmed", note: "07/02 · 현대 · 현지 식당 외식" },
      { label: "STE L2J SAS", amt: 4851, status: "confirmed", note: "07/02 · 현대 · 현지 식당 외식" },
      { label: "LA FLOTTILLE(베르사유)", amt: 140668, status: "confirmed", note: "07/03 · 현대 · 명소 레스토랑" },
      { label: "LE 1981", amt: 118206, status: "confirmed", note: "07/04 · 현대 · 현지 식당 외식" },
      { label: "MABADIS", amt: 64137, status: "confirmed", note: "07/04 · 현대 · 현지 식당 외식" },
      { label: "SQ ARABICA", amt: 31498, status: "confirmed", note: "07/04 · 현대 · 카페·간편식" },
      { label: "LE DAMIE", amt: 118097, status: "confirmed", note: "07/05 · 현대 · 현지 식당 외식" },
      { label: "UBER EATS", amt: 35057, status: "confirmed", note: "07/05 · 현대 · 카페·간편식" },
      { label: "MC DONALD'S", amt: 20041, status: "confirmed", note: "07/05 · 현대 · 현지 식당 외식" },
      { label: "LA BISQUINE(옹플뢰르)", amt: 84041, status: "confirmed", note: "07/06 · 현대 · 현지 식당 외식" },
      { label: "GIVERNY RESTAURATION", amt: 17763, status: "confirmed", note: "07/06 · 현대 · 현지 식당 외식" },
      { label: "DUPONT NAVET", amt: 170407, status: "confirmed", note: "07/07 · 현대 · 현지 식당 외식" },
      { label: "RAVIOLIS NOTRE DAME", amt: 112433, status: "confirmed", note: "07/07 · 현대 · 현지 식당 외식" },
      { label: "JOAYO", amt: 175019, status: "confirmed", note: "07/08 · 현대 · 현지 식당 외식" },
      { label: "AICHINGER GASTRO(뮌헨공항)", amt: 77239, status: "confirmed", note: "07/08 · 현대 · 이동 중 식사" },
      { label: "MUC Airport Gastro", amt: 9326, status: "confirmed", note: "07/08 · 현대 · 이동 중 식사" },
    ],
  },
  {
    id: 'transport', cat: '🚄 교통', amt: '₩2,594,001', amtNum: 2594001,
    detail: '스위스패스·산악열차·기차·우버·택시·캐리어운반',
    pct: 5, color: '#7C3AED',
    actual: 4580530,
    settleNote: '결산 ₩4,580,530 — 스위스패스(SBB)·공항기차·영국 Trainline(재발권)·파리 Navigo·우버·택시·캐리어운반. 예산 대비 +₩2.0M',
    breakdown: [
      { label: "WWW.TOPSANTIAGO.COM", amt: 249001, status: "confirmed", note: "06/13 · VIVA · 카미노 캐리어운반" },
      { label: "TMP MANUEL LEAO", amt: 3559, status: "confirmed", note: "06/13 · VIVA · 포르토 교통" },
      { label: "SBB Saver 3인", amt: 2313632, status: "confirmed", note: "06/14 · VIVA · 스위스패스(가족3인)" },
      { label: "SBB Youth", amt: 601123, status: "confirmed", note: "06/14 · VIVA · 스위스패스(둘째)" },
      { label: "TMP MANUEL LEAO", amt: 7119, status: "confirmed", note: "06/14 · VIVA · 포르토 교통" },
      { label: "TMP SAO BENTO", amt: 6045, status: "confirmed", note: "06/14 · VIVA · 포르토 교통" },
      { label: "XACOBEOTRANSFER", amt: 31896, status: "confirmed", note: "06/17 · VIVA · 카미노 셔틀" },
      { label: "우버", amt: 15902, status: "confirmed", note: "06/17 · VIVA · 우버" },
      { label: "AUTO TAXI SANTIAGO", amt: 53340, status: "confirmed", note: "06/24 · 현대 · 택시·공항" },
      { label: "SBB BAHNHOF FLUGHAFEN", amt: 118947, status: "confirmed", note: "06/25 · 현대 · 스위스 기차" },
      { label: "SumUp Taxi Guessaymi", amt: 88250, status: "confirmed", note: "06/25 · 현대 · 택시·공항" },
      { label: "TRAINLINE", amt: 679881, status: "confirmed", note: "06/28 · 현대 · 영국 기차(재발권)" },
      { label: "UBER", amt: 77772, status: "confirmed", note: "07/01 · 현대 · 우버" },
      { label: "UBER", amt: 76614, status: "confirmed", note: "07/01 · 현대 · 우버" },
      { label: "티머니공항리무진", amt: 34000, status: "confirmed", note: "07/01 · 현대 · 택시·공항" },
      { label: "UBER TRIP", amt: 1943, status: "confirmed", note: "07/01 · 현대 · 우버" },
      { label: "MOMENTUM(유로스타)", amt: 67053, status: "confirmed", note: "07/02 · 현대 · 유로스타 부대" },
      { label: "TfL Travel", amt: 54281, status: "confirmed", note: "07/02 · 현대 · 런던 교통" },
      { label: "SERVICE NAVIGO", amt: 18291, status: "confirmed", note: "07/02 · 현대 · 파리 주간권" },
      { label: "TfL Travel", amt: 6469, status: "confirmed", note: "07/02 · 현대 · 런던 교통" },
      { label: "SERVICE NAVIGO", amt: 18262, status: "confirmed", note: "07/03 · 현대 · 파리 주간권" },
      { label: "Velib", amt: 5369, status: "confirmed", note: "07/04 · 현대 · 파리 자전거" },
      { label: "SERVICE NAVIGO", amt: 18246, status: "confirmed", note: "07/05 · 현대 · 파리 주간권" },
      { label: "Velib", amt: 5369, status: "confirmed", note: "07/05 · 현대 · 파리 자전거" },
      { label: "UBER", amt: 28166, status: "confirmed", note: "07/07 · 현대 · 우버" },
    ],
  },
  {
    id: 'admission', cat: '🎫 체험·입장료', amt: '₩2,500,000', amtNum: 2500000,
    detail: '산악열차·궁전·미술관·투어 (직접결제 포함)',
    pct: 6, color: '#F59E0B',
    actual: 4206608,
    settleNote: '결산 ₩4,206,608 — 융프라우·고르너그라트·수네가·필라투스+베르사유·지베르니·생트샤펠(2명)+루브르 입장(아들 €96)·루브르오디오·오르세도슨트·메르시투어(직접결제). 예산 대비 +₩1.71M',
    breakdown: [
      { label: "Jungfraubahnen", amt: 1462695, status: "confirmed", note: "06/16 · VIVA · 융프라우요호(4인)" },
      { label: "PILATUS BAHNEN", amt: 10602, status: "confirmed", note: "06/25 · 현대 · 필라투스" },
      { label: "ZERMATT STATION GGB(고르너그라트)", amt: 510906, status: "confirmed", note: "06/27 · 현대 · 고르너그라트(마테호른)" },
      { label: "ZBAG SUNNEGGA EXPRESS", amt: 116109, status: "confirmed", note: "06/27 · 현대 · 수네가 푸니쿨라" },
      { label: "ZBAG SUNNEGGA EXPRESS", amt: 69671, status: "confirmed", note: "06/27 · 현대 · 수네가 푸니쿨라" },
      { label: "MY TOP TOUR", amt: 315856, status: "confirmed", note: "06/28 · 현대 · 현지 투어" },
      { label: "CHAT.VERSAILLES", amt: 187372, status: "confirmed", note: "06/28 · 현대 · 베르사유 궁전" },
      { label: "MY TOP TOUR", amt: 214086, status: "confirmed", note: "06/29 · 현대 · 현지 투어" },
      { label: "오르세 도슨트 (6인 공인가이드)", amt: 180600, status: "confirmed", note: "07/02 · 직접 · 오르세 도슨트(3명)" },
      { label: "ORPHEO FRANCE", amt: 26863, status: "confirmed", note: "07/03 · 현대 · 오르세 오디오" },
      { label: "루브르 입장권 (3명)", amt: 170000, status: "confirmed", note: "07/04 · 아들 · 루브르 입장(3명)" },
      { label: "루브르 한국어 오디오가이드 (2개)", amt: 70000, status: "confirmed", note: "07/04 · 직접 · 루브르 오디오가이드" },
      { label: "메르시파리 투어 (몽생미셀+지베르니+옹플뢰르)", amt: 717000, status: "confirmed", note: "07/06 · 직접 · 몽생미셀 투어(3명)" },
      { label: "MUSEE CLAUDE MONET(지베르니)", amt: 31992, status: "confirmed", note: "07/06 · 현대 · 지베르니 모네미술관" },
      { label: "CENTRE DES MONUMENTS NAT", amt: 77781, status: "confirmed", note: "07/08 · 현대 · 생트샤펠·콘시에르주리(2명)" },
      { label: "CENTRE DES MONUMENTS NAT", amt: 45075, status: "confirmed", note: "07/08 · 현대 · 생트샤펠·콘시에르주리(2명)" },
    ],
  },
  {
    ...
    pct: 3, color: '#475569',
    actual: 72169,
    settleNote: '결산 ₩72,169 — 영국 ETA ₩43,185 + 셰익스피어앤코 서점 ₩28,984. 예산 대비 −₩0.93M',
    breakdown: [
      { label: "UKVI ETA", amt: 43185, status: "confirmed", note: "06/23 · 현대 · 영국 ETA" },
      { label: "SC-LIB SHAKESPEARE", amt: 28984, status: "confirmed", note: "07/08 · 현대 · 서점(기념품)" },
    ],
  },
];
