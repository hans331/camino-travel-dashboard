...
export const SCHEDULE: DayData[] = [
  ...
  {
    day: 24, date: '7/5 (일)', phase: 'paris', title: '📚 라탱지구 (아내·아들 점심) + 🎨 l\'Orangerie + 👨‍👩‍👦 Hans 16시 합류 저녁',
    icon: '📚', desc: '⭐ 오늘 늦은 시작 → 2군데 집중. 아내+아들 라탱지구 점심 + 셰익스피어 서점 + 시테섬 → 14:30 l\'Orangerie 모네 수련 → 16시 Hans Tuileries 합류 → 튀일리·생제르맹 카페 산책 → 가족 저녁 → 20시 호텔. ⚠️ 7/6 메르시파리 05:30 기상 대비 22시 취침.',
    food: '아내+아들 라탱지구 점심 (Bouillon Racine) · 저녁 생제르맹 or 라탱지구 (L\'Épigramme·Le Coupe-Chou)', stay: '✅ Hampton By Hilton Paris Saint Ouen — 같은 숙소 연박',
    lat: 48.8584, lng: 2.3237,
    transit: '🚇 Métro 14 (Saint-Ouen 직결) → Châtelet → Métro 4 (라탱) · l\'Orangerie: Métro 1 Concorde',
    restaurants: ['⭐ Bouillon Racine (라탱지구 1906년 전통)', 'Café de Flore (생제르맹 카페)', 'L\'Épigramme (생제르맹 비스트로)', 'Le Coupe-Chou (라탱지구 저녁)'],
    timeline: [
      { time: '11:30-12:00', emoji: '🚇', label: '👥 아내+아들: 호텔 → Saint-Michel (Métro 14 → 4)', status: 'pending', detail: '~25분 · Saint-Ouen → Châtelet → Métro 4 → Saint-Michel' },
      { time: '12:00-13:30', emoji: '🍽️', label: '🍽️ ⭐ 아내+아들 라탱지구 점심 — Bouillon Racine', status: 'pending', detail: '⭐ 1906년 전통 파리 비스트로 · €15-20/인 · 아르누보 인테리어 · Rue Racine 3 (Odéon 근처)' },
      { time: '13:30-14:00', emoji: '📚', label: '📚 ⭐ 셰익스피어 & 컴퍼니 서점 + 시테섬 강변', status: 'pending', detail: '1919년 실비아 비치 창립 · 조이스·헤밍웨이 단골 · 노트르담 정면 뷰 · 짧게 20-30분' },
      { time: '14:00-14:30', emoji: '🚇', label: '👥 라탱지구 → Concorde (Métro 4 → 1)', status: 'pending', detail: 'Saint-Michel → Châtelet → Métro 1 → Concorde · ~20분' },
      { time: '14:30-16:00', emoji: '🎨', label: '🎨 ⭐ l\'Orangerie 모네 수련 (Nymphéas)', status: 'pending', detail: '€12.50/인 × 3 = €37.50 · musee-orangerie.fr 사전 예매 필수 · 8개 거대 캔버스 타원형 방' },
      { time: '16:00', emoji: '🚹', label: '🚹 ⭐ Hans 합류 — Tuileries 정원 벤치 (l\'Orangerie 옆)', status: 'pending', detail: '⭐ 정확 위치: Tuileries 정원 카페 옆 벤치 또는 Concorde 역 출구 1번 · 사전 문자 공유 · Hans는 Métro 14 Saint-Ouen → Concorde 직결 (~15분)' },
      { time: '16:00-17:00', emoji: '🚶', label: '👨‍👩‍👦 튀일리 정원 + 팔레 로얄 산책', status: 'pending', detail: '튀일리 정원 벤치 여유 → Rue de Rivoli 도보 → 팔레 로얄 조각 열주 (그리고 여유롭게)' },
      { time: '17:00-18:00', emoji: '☕', label: '☕ ⭐ 생제르맹 카페 — Café de Flore 또는 Les Deux Magots', status: 'pending', detail: '⭐ 사르트르·헤밍웨이·피카소 단골 · 노천 테라스 · 커피 €7-10 · Hans 첫 생제르맹 카페' },
      { time: '18:00-19:30', emoji: '🍽️', label: '🍽️ ⭐ 가족 저녁 — 생제르맹 or 라탱지구', status: 'pending', detail: '⭐ L\'Épigramme (생제르맹 조용 비스트로, 예약 권장) · Brasserie Lipp (역사) · Le Coupe-Chou (라탱지구 오래된 비스트로, Hans 첫 라탱 저녁) · ⚠️ Le Comptoir du Relais는 7/7 만찬 아껴둠' },
      { time: '19:30-20:00', emoji: '🚇', label: '호텔로 이동 — Uber 권장 (편함)', status: 'pending', detail: '⭐ Uber €20-25 직행 (~20분) · 또는 Métro 4 → 14' },
      { time: '20:00-20:30', emoji: '🏨', label: '🏨 호텔 도착 + 7/6 데이팩 최종 점검', status: 'pending', detail: '⭐ 카메라·우산·자켓·간식·물·SPF·선글라스·현금 (입장료 €87 + 픽업비 €40 + 점심)' },
      { time: '21:00', emoji: '📱', label: '📱 메르시파리 카톡 — 06:30 픽업 시간 재확인', status: 'pending' },
