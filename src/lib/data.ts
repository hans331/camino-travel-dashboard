...
export const CHECKLIST: ChecklistCategory[] = [
  {
    ...
    items: [
      'Day 1 · 6/12 (금) ⏳ 부부 ICN→ZRH→OPO · Swiss Air LX 09:30→18:15 (ZRH 환승, Economy Basic Plus, ₩1,988,000/2인) — 6/15→6/12 변경 결제완료, 항공사 시스템 반영 대기',
  ...
  },
  {
    ...
    items: [
      ...
      'Day 13 · 6/24 (수) 🚂 둘째 Cambridge→LHR/LGW 1명 (오전, Swiss/BA 탑승 전 이동)',
  ...
  },
  {
    ...
    items: [
      'Day 1-2 (6/12-13) 🇵🇹 포르토 2박 (부부, 더블룸) — The Editory Boulevard Aliados 또는 동급',
      'Day 3-6 (6/14-17) 🌊 해안길 알베르게/펜션 4박 — Vila do Conde · Esposende · Viana do Castelo · Caminha (사립 펜션 권장, 부부 더블룸)',
      'Day 7-11 (6/18-22) 🌳 중앙길 알베르게/펜션 5박 — Tui · Redondela · Pontevedra · Caldas de Reis · Padrón (사립 펜션 권장, 부부 더블룸)',
      'Day 12 (6/23) ⭐ 산티아고 Hotel Costa Vella 1박 (부부) — 카미노 완주 자축',
      'Day 13-14 (6/24-25) 🇨🇭 루체른 호텔 2박 (3명→4명 Day 14 저녁부터) — Hotel des Balances 또는 Schweizerhof, family room',
      'Day 15-16 (6/26-27) ⭐ 체르마트 호텔 2박 (4명, 마테호른 뷰 객실) — Schweizerhof Zermatt 또는 Cervo Mountain',
      'Day 17-18 (6/28-29) 🇨🇭 인터라켄 호텔 2박 (4명, family room) — Hotel Interlaken 또는 Royal St Georges',
      'Day 19 (6/30) 🇬🇧 캠브리지 University Arms 1박 (4명, 2 rooms) — Parker\'s Piece 앞',
      'Day 20-27 (7/1-7) 🇫🇷 파리 7박 (3명, 2 rooms) — Hôtel des Grands Boulevards 또는 9구 마레/오페라 도보권',
    ],
  },
  {
    title: '비자·서류·ETA·금융',
    items: [
      ...
      '📕 여권 유효기간 6개월 이상 확인 × 4명',
      '🛡️ 여행자 보험 가입 (하이킹·산악·의료 커버 포함) × 4명',
      '🐚 순례자 크리덴셜 (Credencial del Peregrino) — 포르토 대성당 6/14 첫날 수령',
      '🎓 캠브리지 졸업식 초청장·드레스코드·시간 확인 (둘째와 통화)',
      '🏢 회사 휴가 신청 (6/12-7/9 → 7/10 금 또는 7/13 월 출근 권장)',
      '💳 신용카드 2장 해외 사용 가능 여부 확인 + 카드사 출국 알림',
      '💵 환전·현금 준비: €500 + £150 + CHF 100 또는 현지 ATM 인출 계획',
      '📄 항공권·호텔·기차·입장권 예약 확인서 출력/PDF 저장 (이메일 폴더 정리)',
      '📋 여권 사본 별도 보관 × 4명 (분실 대비, 클라우드 백업 포함)',
    ],
  },
  {
    title: '관광 입장권·체험 사전 예매',
    items: [
      'Day 2 (6/13) 🍷 포르토 포트와인 셀러 투어 2인 (Taylor\'s 또는 Graham\'s)',
      'Day 14 (6/25) 🏔️ Mt. Pilatus Golden Round Trip 4인 (CHF 78/인, Swiss Pass 50% 할인) — 큰아들 합류 다음 날',
      'Day 16 (6/27) ⛰️ Gornergrat 톱니바퀴열차 4인 (CHF 132/인, 마테호른 클래식 뷰)',
      'Day 18 (6/29) ⛰️ 융프라우요호 Top of Europe 4인 (CHF 232/인, Swiss Pass 25% 할인) — 사전 예매 필수',
      'Day 19 또는 20 (6/30 or 7/1) 🚣 캠브리지 펀팅 보트 4인',
      'Day 21 (7/2) 🎨 오르세 미술관 3인 (오전, 인상파 핵심)',
      'Day 21 (7/2) 🗼 에펠탑 3인 (오후, 시간 지정 예매 필수)',
      'Day 22 (7/3) 👑 베르사유 궁전 3인 (정원+트리아농 포함권)',
      'Day 23 (7/4) 🖼️ 루브르 박물관 3인 (오전, 시간 지정 예매 필수)',
      'Day 24 (7/5) 🌻 지베르니 모네의 정원 3인 (사전 예매 권장)',
      'Day 25 (7/6) 🏰 Mont-Saint-Michel TGV + 셔틀 + 입장권 3인 (~₩170K/인) — 사전 예매 강력 권장',
      'Day 26 (7/7) 🎨 l\'Orangerie 모네 수련 3인 (오전)',
      '⛪ 사크레쾨르·생트샤펠·노트르담 외부 등 무료 입장 (예매 불필요)',
    ],
  },
  {
    title: '카미노 준비물 (부부 2명)',
    items: [
      '🥾 등산화 × 2 (출국 D-14부터 길들이기 시작! ⚠️)',
      ...
      '💧 물통 1L × 2 (Hydro Flask / Nalgene)',
      '🦶 발 관리 키트 (바셀린·콤피드·압박붕대·발톱깎이·반창고)',
      '🎒 데이팩 작은 가방 × 2 (짐 운반 서비스 사용 시 도시락·생수용)',
      '📖 카미노 가이드북 — Brierley "Camino Portugués"',
      '📦 짐 운반 서비스 신청 (Tuitrans 또는 Correos El Camino, €6-8/일 × 10일)',
      '🧺 빨래용품 (작은 빨래판·여행용 세제·빨래 줄 + 집게)',
  ...
  },
  {
    ...
    items: [
      '🧥 따뜻한 옷·플리스 × 4 (산정 0-5°C까지 — 융프라우 3,454m)',
      '🧤 장갑 + 비니 × 4 (Gornergrat 3,089m, 융프라우 산정)',
      '🕶️ 선글라스 × 4 — 눈빛 반사 강함, 자외선 차단 100%',
      '☀️ 자외선 차단제 SPF50 (고지대 자외선 ↑↑)',
      '🥾 가벼운 트레킹 슈즈/운동화 × 2 (카미노 등산화 무거움, 부부는 별도 신발 권장)',
      '📱 Swiss Travel Pass 모바일 활성화 (출국 전 또는 ZRH 공항 즉시)',
      '🧳 체르마트 차량 통행 금지 — 가벼운 캐리어 + 호텔 짐 픽업 서비스 확인',
      '⚡ 스위스 J타입 어댑터 × 2 (영국 G타입·유럽 C타입과 다름! ⚠️)',
      '📷 카메라 풀충전 (마테호른·융프라우 인생샷)',
      '🌡️ 출발 당일 산정 기온 체크 (SBB 앱)',
    ],
  },
  {
    title: '의류·일상',
  ...
  },
  {
    ...
    items: [
      ...
      '🧴 세면도구 100ml 이하 (액체류 별도 비닐 1L, 기내 반입 대비)',
      '🏖️ 속건성 수건 (마이크로파이버) × 2-4',
      '💊 상비약 키트: 진통제·소화제·지사제·항히스타민·연고·반창고·근육이완제',
      '🦟 벌레퇴치 스프레이 (카미노 시골길 모기·진드기)',
      '🎧 귀마개 + 안대 (알베르게 다인실 + 장거리 비행 필수)',
      '🦶 발 마사지 크림·근육통 연고 (매일 저녁 케어)',
      '🦠 손소독제 + 마스크 (장거리 비행·환승 시)',
      '💊 개인 처방약 (필요 시, 영문 처방전 동봉)',
      '👜 여성용품 (필요 시)',
    ],
  },
  {
    ...
    items: [
      ...
      '🔌 유럽 C타입 어댑터 × 4 (포·스·프 공통)',
      '🔌 영국 G타입 어댑터 × 2 (런던·캠브리지)',
      '🔌 스위스 J타입 어댑터 × 2 (스위스 전용 — C타입과 다름! ⚠️)',
      '📡 eSIM 사전 구매: 유럽(Airalo/Holafly) + UK + 스위스 (또는 글로벌 통합)',
      '📷 카메라 (선택, 또는 휴대폰)',
      '📓 카미노 도장북·메모장 (크리덴셜 외 추가)',
      '📲 여행 앱 설치: Google Maps · Translate · Camino Ninja · SBB(스위스) · Trainline(영국) · Booking.com · Eurostar · Citymapper',
      '🔐 비밀번호 관리 (1Password 등) — 호텔/항공 예약 확인 시 필요',
      '💾 사진 백업: Google Photos 자동 업로드 설정 확인',
    ],
  },
];
