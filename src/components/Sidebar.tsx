...
const TRIP_START = new Date('2026-06-12');
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''} ${isCollapsed ? 'collapsed' : ''}`}>
        ...
        <div className="sidebar-top">
          <div className="sidebar-brand">
            ...
            {!isCollapsed && <p>포르토(2일) · 카미노(10일) · 스위스(6일·🏔️⛰️) · 캠브리지 · 파리(8일) 28일</p>}
          </div>
        ...
        <div className="sidebar-dday">
          ...
          {!isCollapsed && <div className="dday-label">2026.06.12 (금) 출발 ✈️</div>}
        </div>

        {!isCollapsed && (
          <div className="sidebar-party">
            <div className="sidebar-party-row">
              <span><span className="party-emoji">👫</span> 부부 (Day 1-12)</span>
              <span className="party-count">2명</span>
            </div>
            <div className="sidebar-party-row">
              <span><span className="party-emoji">👨‍👩‍👦</span> +둘째 ZRH 합류 (Day 13)</span>
              <span className="party-count">3명</span>
            </div>
            <div className="sidebar-party-row">
              <span><span className="party-emoji">👨‍👩‍👦‍👦</span> +큰아들 Lucerne (Day 14 저녁)</span>
